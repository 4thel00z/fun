pub fn NewStaticPipeWriter(comptime ProcessType: type) type {
    return struct {
        ...
        const WriterRefCount = fun.ptr.RefCount(@This(), "ref_count", _deinit, .{});
        pub const ref = WriterRefCount.ref;
        pub const deref = WriterRefCount.deref;

        const print = fun.Output.scoped(.StaticPipeWriter, .visible);

        pub const IOWriter = fun.io.BufferedWriter(@This(), struct {
        ...
        pub fn start(this: *This) fun.sys.Maybe(void) {
        ...
        pub fn onWrite(this: *This, amount: usize, status: fun.io.WriteStatus) void {
        ...
        pub fn onError(this: *This, err: fun.sys.Error) void {
