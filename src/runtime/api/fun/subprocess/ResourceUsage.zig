...
pub fn create(rusage: *const Rusage, globalObject: *JSGlobalObject) fun.JSError!JSValue {
    return fun.new(ResourceUsage, .{ .rusage = rusage.* }).toJS(globalObject);
}

pub fn getCPUTime(this: *ResourceUsage, globalObject: *JSGlobalObject) fun.JSError!JSValue {
