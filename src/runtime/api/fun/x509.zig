...
pub fn toJS(cert: *BoringSSL.X509, globalObject: *JSGlobalObject) fun.JSError!JSValue {
    return fun.jsc.fromJSHostCall(globalObject, @src(), Fun__X509__toJSLegacyEncoding, .{ cert, globalObject });
}

pub fn toJSObject(cert: *BoringSSL.X509, globalObject: *JSGlobalObject) fun.JSError!JSValue {
    return Fun__X509__toJS(cert, globalObject);
}

extern fn Fun__X509__toJSLegacyEncoding(cert: *BoringSSL.X509, globalObject: *JSGlobalObject) JSValue;
extern fn Fun__X509__toJS(cert: *BoringSSL.X509, globalObject: *JSGlobalObject) JSValue;
