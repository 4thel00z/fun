...
function adapterFromOptions(options: Fun.SQL.__internal.DefinedOptions) {
...
const SQL: typeof Fun.SQL = function SQL(
  stringOrUrlOrOptions: Fun.SQL.Options | string | undefined = undefined,
...
var defaultSQLObject: Fun.SQL = function sql(strings, ...values) {
  if (new.target) {
    return SQL(strings);
  }
