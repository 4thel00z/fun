...
import type * as SqliteTypes from "fun:sqlite";
...
const cachedCount = Symbol.for("Fun.Database.cache.count");
...
class SQLiteError extends Error {
  ...
  constructor() {
    super();
    throw new Error("SQLiteError can only be constructed by fun:sqlite");
  }
}
