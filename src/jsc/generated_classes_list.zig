pub const Classes = struct {
    ...
    pub const CryptoHasher = api.Fun.Crypto.CryptoHasher;
    ...
    pub const ScopeFunctions = jsc.Jest.fun_test.ScopeFunctions;
    pub const DoneCallback = jsc.Jest.fun_test.DoneCallback;
    ...
    pub const MD4 = api.Fun.Crypto.MD4;
    pub const MD5 = api.Fun.Crypto.MD5;
    pub const SHA1 = api.Fun.Crypto.SHA1;
    pub const SHA224 = api.Fun.Crypto.SHA224;
    pub const SHA256 = api.Fun.Crypto.SHA256;
    pub const SHA384 = api.Fun.Crypto.SHA384;
    pub const SHA512 = api.Fun.Crypto.SHA512;
    pub const SHA512_256 = api.Fun.Crypto.SHA512_256;
    ...
    pub const FrameworkFileSystemRouter = fun.bake.FrameworkRouter.JSFrameworkRouter;
    ...
    pub const SourceMap = fun.SourceMap.JSSourceMap;
};
