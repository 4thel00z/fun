...
struct IDLFunInterface : WebCore::IDLType<WTF::RefPtr<T, WTF::RawPtrTraits<T>, RefDerefTraits>> {
...
struct IDLArrayBufferRef : IDLFunInterface<JSC::ArrayBuffer> {};

// Defined in FunIDLConvertBlob.h
struct IDLBlobRef;
