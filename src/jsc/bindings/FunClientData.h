...
public:
    ...
    FunBuiltinNames& builtinNames() { return m_builtinNames; }
    ...
    void* funVM;
    Fun::JSCTaskScheduler deferredWorkTimer;

    // Backing storage for Fun::IsolatedModuleCache (see IsolatedModuleCache.h).
...
private:
    ...
    FunBuiltinNames m_builtinNames;
...
static inline FunBuiltinNames& builtinNames(JSC::VM& vm)
{
