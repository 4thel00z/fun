...
class FunBroadcastChannelRegistry {
public:
    static FunBroadcastChannelRegistry& singleton();
...
private:
    friend class WTF::NeverDestroyed<FunBroadcastChannelRegistry>;
    FunBroadcastChannelRegistry() = default;
