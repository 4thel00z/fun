...
static constexpr auto nestedHumanReadableName()
{
    ...
    if constexpr (IDLHumanReadableName<IDL>::isDisjunction) {
        return Fun::concatCStrings("<", name, ">");
    } else {
        return name;
    }
}
...
template<> struct IDLHumanReadableName<Fun::IDLStrictNull> : BaseIDLHumanReadableName {
    static constexpr auto humanReadableName = std::to_array("null");
};

template<> struct IDLHumanReadableName<Fun::IDLStrictUndefined> : BaseIDLHumanReadableName {
...
struct IDLHumanReadableName<WebCore::IDLNullable<IDL>> : BaseIDLHumanReadableName {
    ...
    static constexpr auto humanReadableName = Fun::concatCStrings(
...
struct IDLHumanReadableName<Fun::IDLArray<IDL>> : BaseIDLHumanReadableName {
    static constexpr bool hasPreposition = true;
    static constexpr auto humanReadableName
        = Fun::concatCStrings("array of ", Detail::nestedHumanReadableName<IDL>());
};
...
template<HasIDLHumanReadableName IDL>
struct IDLHumanReadableName<Fun::IDLOrderedUnion<IDL>> : IDLHumanReadableName<IDL> {};

template<HasIDLHumanReadableName... IDL>
struct IDLHumanReadableName<Fun::IDLOrderedUnion<IDL...>> : BaseIDLHumanReadableName {
    static constexpr bool isDisjunction = sizeof...(IDL) > 1;
    static constexpr auto humanReadableName
        = Fun::joinCStringsAsList(Detail::nestedHumanReadableName<IDL>()...);
};

template<> struct IDLHumanReadableName<Fun::IDLArrayBufferRef> : BaseIDLHumanReadableName {
    static constexpr auto humanReadableName = std::to_array("ArrayBuffer");
};

template<> struct IDLHumanReadableName<Fun::IDLBlobRef> : BaseIDLHumanReadableName {
