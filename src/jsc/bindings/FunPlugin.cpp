...
extern "C" void Fun__onDidAppendPlugin(void* funVM, JSGlobalObject* globalObject);
...
static JSC::EncodedJSValue jsFunctionAppendOnLoadPluginBody(JSC::JSGlobalObject* globalObject, JSC::CallFrame* callframe, FunPluginTarget target, FunPlugin::Base& plugin, void* ctx, OnAppendPluginCallback callback)
{
...
static EncodedJSValue jsFunctionAppendVirtualModulePluginBody(JSC::JSGlobalObject* globalObject, JSC::CallFrame* callframe)
{
    ...
    if (Fun::isBuiltinModule(moduleId)) {
    ...
    if (global->onLoadPlugins.virtualModules == nullptr) {
        global->onLoadPlugins.virtualModules = new FunPlugin::VirtualModuleMap;
    }
...
static JSC::EncodedJSValue jsFunctionAppendOnResolvePluginBody(JSC::JSGlobalObject* globalObject, JSC::CallFrame* callframe, FunPluginTarget target, FunPlugin::Base& plugin, void* ctx, OnAppendPluginCallback callback)
{
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);
...
static JSC::EncodedJSValue jsFunctionAppendOnResolvePluginGlobal(JSC::JSGlobalObject* globalObject, JSC::CallFrame* callframe, FunPluginTarget target)
{
    Zig::GlobalObject* global = defaultGlobalObject(globalObject);

    auto& plugins = global->onResolvePlugins;
    auto callback = Fun__onDidAppendPlugin;
    return jsFunctionAppendOnResolvePluginBody(globalObject, callframe, target, plugins, global->funVM(), callback);
}

static JSC::EncodedJSValue jsFunctionAppendOnLoadPluginGlobal(JSC::JSGlobalObject* globalObject, JSC::CallFrame* callframe, FunPluginTarget target)
{
    Zig::GlobalObject* global = defaultGlobalObject(globalObject);

    auto& plugins = global->onLoadPlugins;
    auto callback = Fun__onDidAppendPlugin;
    return jsFunctionAppendOnLoadPluginBody(globalObject, callframe, target, plugins, global->funVM(), callback);
}

JSC_DEFINE_HOST_FUNCTION(jsFunctionAppendOnLoadPluginNode, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    return jsFunctionAppendOnLoadPluginGlobal(globalObject, callframe, FunPluginTargetNode);
}

JSC_DEFINE_HOST_FUNCTION(jsFunctionAppendOnLoadPluginFun, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    return jsFunctionAppendOnLoadPluginGlobal(globalObject, callframe, FunPluginTargetFun);
}

JSC_DEFINE_HOST_FUNCTION(jsFunctionAppendOnLoadPluginBrowser, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    return jsFunctionAppendOnLoadPluginGlobal(globalObject, callframe, FunPluginTargetBrowser);
}

JSC_DEFINE_HOST_FUNCTION(jsFunctionAppendOnResolvePluginNode, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    return jsFunctionAppendOnResolvePluginGlobal(globalObject, callframe, FunPluginTargetNode);
}

JSC_DEFINE_HOST_FUNCTION(jsFunctionAppendOnResolvePluginFun, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    return jsFunctionAppendOnResolvePluginGlobal(globalObject, callframe, FunPluginTargetFun);
}
...
{
    return jsFunctionAppendOnResolvePluginGlobal(globalObject, callframe, FunPluginTargetBrowser);
}

/// `Fun.plugin()`
static inline JSC::EncodedJSValue setupFunPlugin(JSC::JSGlobalObject* globalObject, JSC::CallFrame* callframe, FunPluginTarget target)
{
    auto& vm = JSC::getVM(globalObject);
    ...
    if (targetValue) {
        if (auto* targetJSString = targetValue.toStringOrNull(globalObject)) {
            ...
            if (!(targetString == "node"_s || targetString == "fun"_s || targetString == "browser"_s)) {
                JSC::throwTypeError(globalObject, throwScope, "plugin target must be one of 'node', 'fun' or 'browser'"_s);
                return {};
            }
        }
    }
    ...
    builderObject->putDirect(vm, Identifier::fromString(vm, "target"_s), jsString(vm, String("fun"_s)), 0);
    builderObject->putDirectNativeFunction(
        vm,
        globalObject,
        JSC::Identifier::fromString(vm, "onLoad"_s),
        1,
        jsFunctionAppendOnLoadPluginFun,
    ...
    builderObject->putDirectNativeFunction(
        ...
        1,
        jsFunctionAppendOnResolvePluginFun,
        ImplementationVisibility::Public,
        NoIntrinsic,
        JSC::PropertyAttribute::DontDelete | 0);
...
void FunPlugin::Group::append(JSC::VM& vm, JSC::RegExp* filter, JSC::JSObject* func)
{
    filters.append(JSC::Strong<JSC::RegExp> { vm, filter });
    callbacks.append(JSC::Strong<JSC::JSObject> { vm, func });
}

void FunPlugin::Base::append(JSC::VM& vm, JSC::RegExp* filter, JSC::JSObject* func, String& namespaceString)
{
...
JSC::JSObject* FunPlugin::Group::find(JSC::JSGlobalObject* globalObject, String& path)
{
...
void FunPlugin::OnLoad::addModuleMock(JSC::VM& vm, const String& path, JSC::JSObject* mockObject)
{
    ...
    if (globalObject->onLoadPlugins.virtualModules == nullptr) {
        globalObject->onLoadPlugins.virtualModules = new FunPlugin::VirtualModuleMap;
    }
...
FUN_DECLARE_HOST_FUNCTION(JSMock__jsModuleMock);
extern "C" JSC_DEFINE_HOST_FUNCTION(JSMock__jsModuleMock, (JSC::JSGlobalObject * lexicalGlobalObject, JSC::CallFrame* callframe))
{
    ...
    auto resolveSpecifier = [&]() -> void {
        ...
        if (url.isValid() && url.protocolIsFile()) {
            ...
            FunString from = Fun::toString(fromString);
            auto topExceptionScope = DECLARE_TOP_EXCEPTION_SCOPE(vm);
            auto result = JSValue::decode(Fun__resolveSyncWithSource(globalObject, JSValue::encode(specifierString), &from, true, false));
    ...
    if (entryValue) {
        removeFromCJS = true;
        if (auto* moduleObject = entryValue ? dynamicDowncast<Fun::JSCommonJSModule>(entryValue) : nullptr) {
            JSValue exportsValue = getJSValue();
            RETURN_IF_EXCEPTION(scope, {});

            moduleObject->putDirect(vm, Fun::builtinNames(vm).exportsPublicName(), exportsValue, 0);
...
EncodedJSValue FunPlugin::OnLoad::run(JSC::JSGlobalObject* globalObject, FunString* namespaceString, FunString* path)
{
    Group* groupPtr = this->group(namespaceString ? namespaceString->toWTFString(FunString::ZeroCopy) : String());
    if (groupPtr == nullptr) {
        return JSValue::encode(jsUndefined());
    }
...
std::optional<String> FunPlugin::OnLoad::resolveVirtualModule(const String& path, const String& from)
{
...
EncodedJSValue FunPlugin::OnResolve::run(JSC::JSGlobalObject* globalObject, FunString* namespaceString, FunString* path, FunString* importer)
{
    Group* groupPtr = this->group(namespaceString ? namespaceString->toWTFString(FunString::ZeroCopy) : String());
    if (groupPtr == nullptr) {
        return JSValue::encode(jsUndefined());
    ...
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);
    WTF::String pathString = path->toWTFString(FunString::ZeroCopy);
    ...
    for (size_t i = 0; i < filters.size(); i++) {
        ...
        const auto& builtinNames = WebCore::builtinNames(vm);
        auto* pathJS = Fun::toJS(globalObject, *path);
        RETURN_IF_EXCEPTION(scope, {});
        paramsObject->putDirect(
            vm, builtinNames.pathPublicName(),
            pathJS);
        auto* importerJS = Fun::toJS(globalObject, *importer);
        RETURN_IF_EXCEPTION(scope, {});
        paramsObject->putDirect(
...
extern "C" JSC::EncodedJSValue Fun__runOnResolvePlugins(Zig::GlobalObject* globalObject, FunString* namespaceString, FunString* path, FunString* from, FunPluginTarget target)
{
    return globalObject->onResolvePlugins.run(globalObject, namespaceString, path, from);
}

extern "C" JSC::EncodedJSValue Fun__runOnLoadPlugins(Zig::GlobalObject* globalObject, FunString* namespaceString, FunString* path, FunPluginTarget target)
{
...
JSC::JSValue runVirtualModule(Zig::GlobalObject* globalObject, FunString* specifier, bool& wasModuleMock)
{
    auto fallback = [&]() -> JSC::JSValue {
        return JSValue::decode(Fun__runVirtualModule(globalObject, specifier));
    };
    ...
    auto& virtualModules = *globalObject->onLoadPlugins.virtualModules;
    WTF::String specifierString = specifier->toWTFString(FunString::ZeroCopy);
...
FUN_DEFINE_HOST_FUNCTION(jsFunctionFunPluginClear, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
...
FUN_DEFINE_HOST_FUNCTION(jsFunctionFunPlugin, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    return Fun::setupFunPlugin(globalObject, callframe, FunPluginTargetFun);
}
