...
WTF::String generateHeapProfile(JSC::VM& vm)
{
    ...
    // ==================== HEADER ====================
    output.append("# Fun Heap Profile\n\n"_s);
    output.append("Generated by `fun --heap-prof-md`. This profile contains complete heap data in markdown format.\n\n"_s);
...
extern "C" FunString Fun__generateHeapProfile(JSC::VM* vm)
{
    WTF::String result = Fun::generateHeapProfile(*vm);
    return Fun::toStringRef(result);
}

extern "C" FunString Fun__generateHeapSnapshotV8(JSC::VM* vm)
{
    WTF::String result = Fun::generateHeapSnapshotV8(*vm);
    return Fun::toStringRef(result);
}
