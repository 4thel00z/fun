...
#define CHECK_ROOT_INDEX(NAME)                                                                                                                \
    static_assert(v8::Isolate::NAME == real_v8::internal::Internals::NAME, "Isolate root index " #NAME " does not match between Fun and V8"); \
    static_assert(v8::Isolate::NAME < std::tuple_size_v<decltype(v8::Isolate::m_roots)>, "Fun v8::Isolate roots array is too small for index " #NAME);
