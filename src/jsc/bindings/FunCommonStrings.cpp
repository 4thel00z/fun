...
#define FUN_COMMON_STRINGS_LAZY_PROPERTY_DEFINITION(jsName)                        \
...
#define FUN_COMMON_STRINGS_LAZY_PROPERTY_DEFINITION_NOT_BUILTIN_NAMES(methodName, stringLiteral) \
    this->m_commonString_##methodName.initLater(                                                 \
        [](const JSC::LazyProperty<JSGlobalObject, JSString>::Initializer& init) {               \
            init.set(jsString(init.vm, AtomString(stringLiteral##_s)));                          \
        });

#define FUN_COMMON_STRINGS_LAZY_PROPERTY_VISITOR(name) this->m_commonString_##name.visit(visitor);
#define FUN_COMMON_STRINGS_LAZY_PROPERTY_VISITOR_NOT_BUILTIN_NAMES(name, literal) this->m_commonString_##name.visit(visitor);

void CommonStrings::initialize()
{
    FUN_COMMON_STRINGS_EACH_NAME(FUN_COMMON_STRINGS_LAZY_PROPERTY_DEFINITION)
    FUN_COMMON_STRINGS_EACH_NAME_NOT_BUILTIN_NAMES(FUN_COMMON_STRINGS_LAZY_PROPERTY_DEFINITION_NOT_BUILTIN_NAMES)
}

template<typename Visitor>
void CommonStrings::visit(Visitor& visitor)
{
    FUN_COMMON_STRINGS_EACH_NAME(FUN_COMMON_STRINGS_LAZY_PROPERTY_VISITOR)
    FUN_COMMON_STRINGS_EACH_NAME_NOT_BUILTIN_NAMES(FUN_COMMON_STRINGS_LAZY_PROPERTY_VISITOR_NOT_BUILTIN_NAMES)
}
...
extern "C" JSC::EncodedJSValue Fun__HTTPMethod__toJS(HTTPMethod method, Zig::GlobalObject* globalObject)
{
...
extern "C" JSC::EncodedJSValue Fun__CommonStringsForZig__toJS(CommonStringsForZig commonString, Zig::GlobalObject* globalObject)
{
...
extern "C" JSC::EncodedJSValue Fun__FetchCacheMode__toJS(FetchCacheMode mode, Zig::GlobalObject* globalObject)
{
    auto& commonStrings = globalObject->commonStrings();
    switch (mode) {
...
extern "C" JSC::EncodedJSValue Fun__FetchRedirect__toJS(FetchRedirect redirect, Zig::GlobalObject* globalObject)
{
    auto& commonStrings = globalObject->commonStrings();
    switch (redirect) {
...
extern "C" JSC::EncodedJSValue Fun__FetchRequestMode__toJS(FetchRequestMode mode, Zig::GlobalObject* globalObject)
{
    auto& commonStrings = globalObject->commonStrings();
    switch (mode) {
