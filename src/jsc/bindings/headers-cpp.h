...
extern "C" const size_t JSC__JSInternalPromise_object_size_ = sizeof(JSC::JSPromise);
extern "C" const size_t JSC__JSInternalPromise_object_align_ = alignof(JSC::JSPromise);
...
extern "C" const size_t Fun__Path_object_size_ = sizeof(Fun__Path);
extern "C" const size_t Fun__Path_object_align_ = alignof(Fun__Path);
...
extern "C" const size_t Fun__ConsoleObject_object_size_ = sizeof(Zig::ConsoleClient);
extern "C" const size_t Fun__ConsoleObject_object_align_ = alignof(Zig::ConsoleClient);
...
extern "C" const size_t Fun__Timer_object_size_ = sizeof(Fun__Timer);
extern "C" const size_t Fun__Timer_object_align_ = alignof(Fun__Timer);
