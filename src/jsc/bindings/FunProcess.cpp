...
#include "fun_dependency_versions.h"
...
#include <cstring>
extern "C" bool Fun__Node__ProcessNoDeprecation;
extern "C" bool Fun__Node__ProcessThrowDeprecation;
...
#if !defined(FUN_WEBKIT_VERSION)
#define FUN_WEBKIT_VERSION "unknown"
#endif
...
extern "C" uint8_t Fun__getExitCode(void*);
extern "C" uint8_t Fun__setExitCode(void*, uint8_t);
extern "C" bool Fun__closeChildIPC(JSGlobalObject*);

extern "C" bool Fun__GlobalObject__connectedIPC(JSGlobalObject*);
extern "C" bool Fun__GlobalObject__hasIPC(JSGlobalObject*);
extern "C" bool Fun__ensureProcessIPCInitialized(JSGlobalObject*);
extern "C" const char* Fun__githubURL;
FUN_DECLARE_HOST_FUNCTION(Fun__Process__send);
...
extern "C" void Fun__suppressCrashOnProcessKillSelfIfDesired();
...
static JSValue constructVersions(VM& vm, JSObject* processObject)
{
    ...
    object->putDirect(vm, JSC::Identifier::fromString(vm, "fun"_s), JSC::jsOwnedString(vm, String(ASCIILiteral::fromLiteralUnsafe(Fun__version)).substring(1)));

    // Use CMake-generated versions
    object->putDirect(vm, JSC::Identifier::fromString(vm, "boringssl"_s), JSC::jsOwnedString(vm, String(ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_BORINGSSL))), 0);
    // https://github.com/underdoc-org/fun/issues/7921
    ...
    object->putDirect(vm, JSC::Identifier::fromString(vm, "libarchive"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_LIBARCHIVE)), 0);
    object->putDirect(vm, JSC::Identifier::fromString(vm, "mimalloc"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_MIMALLOC)), 0);
    object->putDirect(vm, JSC::Identifier::fromString(vm, "picohttpparser"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_PICOHTTPPARSER)), 0);
    object->putDirect(vm, JSC::Identifier::fromString(vm, "uwebsockets"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_UWS)), 0);
    object->putDirect(vm, JSC::Identifier::fromString(vm, "webkit"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_WEBKIT)), 0);
    // Zig version from CMake-generated header
    object->putDirect(vm, JSC::Identifier::fromString(vm, "zig"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_ZIG)), 0);

    // Use commit hash for zlib to match test expectations
    object->putDirect(vm, JSC::Identifier::fromString(vm, "zlib"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_ZLIB_HASH)), 0);

    object->putDirect(vm, JSC::Identifier::fromString(vm, "tinycc"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_TINYCC)), 0);
    object->putDirect(vm, JSC::Identifier::fromString(vm, "lolhtml"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_LOLHTML)), 0);
    object->putDirect(vm, JSC::Identifier::fromString(vm, "ares"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_C_ARES)), 0);

    // Use commit hash for libdeflate to match test expectations
    object->putDirect(vm, JSC::Identifier::fromString(vm, "libdeflate"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_LIBDEFLATE_HASH)), 0);

    object->putDirect(vm, JSC::Identifier::fromString(vm, "usockets"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_USOCKETS)), 0);
    object->putDirect(vm, JSC::Identifier::fromString(vm, "lshpack"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_LSHPACK)), 0);

    // Use commit hash for zstd (semantic version extraction not working yet)
    object->putDirect(vm, JSC::Identifier::fromString(vm, "zstd"_s), JSC::jsOwnedString(vm, ASCIILiteral::fromLiteralUnsafe(FUN_VERSION_ZSTD_HASH)), 0);
...
static JSValue constructProcessReleaseObject(VM& vm, JSObject* processObject)
{
    ...
    release->putDirect(vm, vm.propertyNames->name, jsOwnedString(vm, String("node"_s)), 0); // maybe this should be 'fun' eventually
    release->putDirect(vm, Identifier::fromString(vm, "sourceUrl"_s), jsOwnedString(vm, WTF::String(std::span { Fun__githubURL, strlen(Fun__githubURL) })), 0);
...
extern "C" bool Fun__resolveEmbeddedNodeFile(void*, FunString*);
#if OS(WINDOWS)
extern "C" HMODULE Fun__LoadLibraryFunString(FunString*);
#endif
...
JSC_DEFINE_HOST_FUNCTION(Process_functionDlopen, (JSC::JSGlobalObject * globalObject_, JSC::CallFrame* callFrame))
{
    ...
    if (!Fun__VM__allowAddons(globalObject->funVM())) {
    ...
    // See StandaloneModuleGraph.zig for what this "$funfs" thing is
#if OS(WINDOWS)
#define StandaloneModuleGraph__base_path "B:/~FUN/"_s
#else
#define StandaloneModuleGraph__base_path "/$funfs/"_s
#endif
    bool deleteAfter = false;
    if (filename.startsWith(StandaloneModuleGraph__base_path)) {
        FunString funStr = Fun::toString(filename);
        if (Fun__resolveEmbeddedNodeFile(globalObject->funVM(), &funStr)) {
            filename = funStr.transferToWTFString();
    ...
    // For fun build --compile, we copy the .node file to a temp directory.
    // It's best to delete it as soon as we can.
    // https://github.com/underdoc-org/fun/issues/19550
    const auto tryToDeleteIfNecessary = [&]() {
        ...
        if (deleteAfter) {
            deleteAfter = false;
            Fun__unlink(utf8.data(), utf8.length());
        }
#endif
    };

    // Handle known yet-to-be-working in Fun
    {
        static constexpr ASCIILiteral better_sqlite3_node = "better_sqlite3.node"_s;
        static constexpr ASCIILiteral better_sqlite3_message = "'better-sqlite3' is not yet supported in Fun.\nTrack the status in https://github.com/underdoc-org/fun/issues/4290\nIn the meantime, you could try fun:sqlite which has a similar API."_s;
    ...
    Fun__process_dlopen_count++;

#if OS(WINDOWS)
    FunString filename_str = Fun::toString(filename);
    HMODULE handle = Fun__LoadLibraryFunString(&filename_str);
...
// On Windows, we use GetLastError() for error messages, so we can only delete after checking for errors
    ...
    if (callCountAtStart != globalObject->napiModuleRegisterCallCount) {
        ...
        if (handle) {
            ...
            for (auto& mod : pendingNapiModules) {
                ...
                Fun::DLHandleMap::singleton().add(handle, heapModule);
            }

            // Save all V8 C++ module registrations
            for (auto* mod : pendingV8Modules) {
                Fun::DLHandleMap::singleton().add(handle, mod);
            }
        }
    ...
    if (auto cachedModules = Fun::DLHandleMap::singleton().get(handle)) {
...
#define dlsym GetProcAddress
    ...
    // (fun/src/env.zig:36) and the table at https://github.com/nodejs/node/blob/main/doc/abi_version_registry.json
...
#undef dlsym
    ...
    if (auto resultObject = resultValue.getObject()) {
        ...
        const char** pointer_to_plugin_name = (const char**)dlsym(handle, "FUN_PLUGIN_NAME");
#elif OS(WINDOWS)
        const char** pointer_to_plugin_name = (const char**)GetProcAddress(handle, "FUN_PLUGIN_NAME");
#endif
        if (pointer_to_plugin_name) {
            ...
            auto* meta = new Fun::NapiModuleMeta(globalObject->m_pendingNapiModuleDlopenHandle);
            Fun::NapiExternal* napi_external = Fun::NapiExternal::create(vm, globalObject->NapiExternalStructure(), meta, nullptr, nullptr, env.ptr());
    ...
    // https://github.com/underdoc-org/fun/issues/1288
...
JSC_DEFINE_HOST_FUNCTION(Process_functionUmask, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (value.isString()) {
        ...
        if (!opt.has_value()) return Fun::ERR::INVALID_ARG_VALUE(throwScope, globalObject, "mask"_s, value, "must be a 32-bit unsigned integer or an octal string"_s);
        newUmask = opt.value();
    } else {
        Fun::V::validateUint32(throwScope, globalObject, value, "mask"_s, jsUndefined());
...
extern "C" void Fun__VirtualMachine__exitDuringUncaughtException(void*);
...
extern "C" void Process__dispatchOnBeforeExit(Zig::GlobalObject* globalObject, uint8_t exitCode)
{
    ...
    MarkedArgumentBuffer arguments;
    arguments.append(jsNumber(exitCode));
    Fun__VirtualMachine__exitDuringUncaughtException(funVM(vm));
...
{
    double now = static_cast<double>(Fun__readOriginTimer(funVM(lexicalGlobalObject)));
...
JSC_DEFINE_HOST_FUNCTION(Process_functionExit, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callFrame))
{
    ...
    auto exitCode = Fun__getExitCode(funVM(zigGlobal));
...
JSC_DEFINE_HOST_FUNCTION(Process_setUncaughtExceptionCaptureCallback, (JSC::JSGlobalObject * lexicalGlobalObject, JSC::CallFrame* callFrame))
{
    ...
    if (!arg0.isCallable()) {
        return Fun::ERR::INVALID_ARG_TYPE(throwScope, globalObject, "fn"_s, "function or null"_s, arg0);
    }
    if (process->m_reportOnUncaughtException) {
        return Fun::ERR::UNCAUGHT_EXCEPTION_CAPTURE_ALREADY_SET(throwScope, globalObject);
    }
...
JSC_DEFINE_HOST_FUNCTION(Process_functionHRTime, (JSC::JSGlobalObject * globalObject_, JSC::CallFrame* callFrame))
{
    ...
    uint64_t time = Fun__readOriginTimer(globalObject->funVM());
    ...
    if (callFrame->argumentCount() > 0 && !arg0.isUndefined()) {
        ...
        if (!relativeArray) {
            return Fun::ERR::INVALID_ARG_TYPE(throwScope, globalObject, "time"_s, "Array"_s, arg0);
        }
        if (relativeArray->length() != 2) return Fun::ERR::OUT_OF_RANGE(throwScope, globalObject_, "time"_s, "2"_s, jsNumber(relativeArray->length()));
...
{
    Zig::GlobalObject* globalObject = static_cast<Zig::GlobalObject*>(globalObject_);
    return JSC::JSValue::encode(JSValue(JSC::JSBigInt::createFrom(globalObject, Fun__readOriginTimer(globalObject->funVM()))));
}
...
JSC_DEFINE_HOST_FUNCTION(Process_functionChdir, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callFrame))
{
    ...
    auto value = callFrame->argument(0);
    Fun::V::validateString(scope, globalObject, value, "directory"_s);
    RETURN_IF_EXCEPTION(scope, {});

    ZigString str = Zig::toZigString(value.toWTFString(globalObject));
    JSC::JSValue result = JSC::JSValue::decode(Fun__Process__setCwd(globalObject, &str));
    RETURN_IF_EXCEPTION(scope, {});
...
extern "C" void Fun__onSignalForJS(int signalNumber, Zig::GlobalObject* globalObject)
{
...
#if OS(WINDOWS)
extern "C" uv_signal_t* Fun__UVSignalHandle__init(JSC::JSGlobalObject* lexicalGlobalObject, int signalNumber, void (*callback)(uv_signal_t*, int));
extern "C" uv_signal_t* Fun__UVSignalHandle__close(uv_signal_t*);
#endif
...
#endif
{
    ...
    context->postTaskConcurrently([signalNumber](ScriptExecutionContext& context) {
        Fun__onSignalForJS(signalNumber, uncheckedDowncast<Zig::GlobalObject>(context.jsGlobalObject()));
    });
#else
...
extern "C" void Fun__logUnhandledException(JSC::EncodedJSValue exception);

extern "C" int Fun__handleUncaughtException(JSC::JSGlobalObject* lexicalGlobalObject, JSC::JSValue exception, int isRejection)
{
    ...
    if (!capture.isEmpty() && !capture.isUndefinedOrNull()) {
        ...
        if (auto ex = scope.exception()) {
            ...
            Fun__logUnhandledException(JSValue::encode(JSValue(ex)));
            Fun__Process__exit(lexicalGlobalObject, 1);
        }
...
extern "C" bool Fun__promises__isErrorLike(JSC::JSGlobalObject* globalObject, JSC::JSValue obj)
{
...
extern "C" JSC::EncodedJSValue Fun__noSideEffectsToString(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::EncodedJSValue reason)
{
    auto scope = DECLARE_THROW_SCOPE(vm);
...
extern "C" void Fun__promises__emitUnhandledRejectionWarning(JSC::JSGlobalObject* globalObject, JSC::EncodedJSValue reason, JSC::EncodedJSValue promise)
{
    auto& vm = globalObject->vm();
    auto scope = DECLARE_TOP_EXCEPTION_SCOPE(vm);
    auto warning = JSC::createError(globalObject, "Unhandled promise rejection. This error originated either by "
                                                  ...
                                                  "To terminate the fun process on unhandled promise "
    ...
    JSValue reasonStack {};
    auto is_errorlike = Fun__promises__isErrorLike(globalObject, JSValue::decode(reason));
    ...
    if (!reasonStack) {
        reasonStack = JSValue::decode(Fun__noSideEffectsToString(vm, globalObject, reason));
        CLEAR_IF_EXCEPTION(scope);
    }
...
extern "C" int Fun__handleUnhandledRejection(JSC::JSGlobalObject* lexicalGlobalObject, JSC::JSValue reason, JSC::JSValue promise)
{
    if (!lexicalGlobalObject->inherits(Zig::GlobalObject::info()))
        return false;
    auto* globalObject = uncheckedDowncast<Zig::GlobalObject>(lexicalGlobalObject);
...
extern "C" bool Fun__VM__allowRejectionHandledWarning(void* vm);

extern "C" bool Fun__emitHandledPromiseEvent(JSC::JSGlobalObject* lexicalGlobalObject, JSC::JSValue promise)
{
    ...
    if (Fun__VM__allowRejectionHandledWarning(globalObject->funVM())) {
...
extern "C" void Fun__refChannelUnlessOverridden(JSC::JSGlobalObject* globalObject);
extern "C" void Fun__unrefChannelUnlessOverridden(JSC::JSGlobalObject* globalObject);
extern "C" bool Fun__shouldIgnoreOneDisconnectEventListener(JSC::JSGlobalObject* globalObject);

extern "C" void Fun__ensureSignalHandler();
extern "C" bool Fun__isMainThreadVM();
extern "C" void Fun__onPosixSignal(int signalNumber);

__attribute__((noinline)) static void forwardSignal(int signalNumber)
{
    // We want a function that's equivalent to Fun__onPosixSignal but whose address is different.
    // This is so that we can be sure not to uninstall signal handlers that we didn't install here.
    Fun__onPosixSignal(signalNumber);
}

static void onDidChangeListeners(EventEmitter& eventEmitter, const Identifier& eventName, bool isAdded)
{
    if (Fun__isMainThreadVM()) {
        // IPC handlers
        if (eventName == "message" || eventName == "disconnect") {
            ...
            if (disconnectListenerCount >= 1 && Fun__shouldIgnoreOneDisconnectEventListener(global)) {
                disconnectListenerCount--;
            }
            auto totalListenerCount = messageListenerCount + disconnectListenerCount;
            if (isAdded) {
                if (Fun__GlobalObject__hasIPC(global)
                    && totalListenerCount == 1) {
                    Fun__ensureProcessIPCInitialized(global);
                    Fun__refChannelUnlessOverridden(global);
                }
            } else {
                if (Fun__GlobalObject__hasIPC(global)
                    && totalListenerCount == 0) {
                    Fun__unrefChannelUnlessOverridden(global);
                }
            }
            return;
        }
...
#error unknown OS
                ...
                if (isAdded) {
...
#else
                        signal_handle.handle = Fun__UVSignalHandle__init(
                    ...
                    if (signalToContextIdsMap->find(signalNumber) != signalToContextIdsMap->end() && eventEmitter.listenerCount(eventName) == 0) {
                        ...
                        Fun__UVSignalHandle__close(signal_handle.handle);
#endif
...
extern "C" bool Fun__NODE_NO_WARNINGS();
...
JSC_DEFINE_HOST_FUNCTION(jsFunction_emitWarning, (JSC::JSGlobalObject * lexicalGlobalObject, CallFrame* callFrame))
{
    ...
    if (process->wrapped().hasEventListeners(ident)) {
        ...
        return JSValue::encode(jsUndefined());
    } else if (!Fun__NODE_NO_WARNINGS()) {
        auto jsArgs = JSValue::encode(value);
        Fun__ConsoleObject__messageWithTypeAndLevel(reinterpret_cast<Fun::ConsoleObject*>(globalObject->consoleClient().get())->m_client, static_cast<uint32_t>(MessageType::Log), static_cast<uint32_t>(MessageLevel::Warning), globalObject, &jsArgs, 1);
        RETURN_IF_EXCEPTION(scope, {});
    }
    return JSValue::encode(jsUndefined());
}
...
JSC_DEFINE_HOST_FUNCTION(Process_functionExecve, (JSGlobalObject * lexicalGlobalObject, CallFrame* callFrame))
{
    ...
    Fun::V::validateString(scope, globalObject, execPathValue, "execPath"_s);
    RETURN_IF_EXCEPTION(scope, {});

    Fun::V::validateArray(scope, globalObject, argsValue, "args"_s, jsUndefined());
    RETURN_IF_EXCEPTION(scope, {});

    WTF::String execPath = execPathValue.toWTFString(globalObject);
    RETURN_IF_EXCEPTION(scope, {});
    if (execPath.contains(static_cast<char16_t>(0))) {
        return Fun::ERR::INVALID_ARG_VALUE(scope, globalObject, "execPath"_s,
    ...
    for (unsigned i = 0; i < argsLength; i++) {
        ...
        if (invalid) {
            return Fun::ERR::INVALID_ARG_VALUE(scope, globalObject, makeString("args["_s, i, "]"_s),
    ...
    if (!envValue.isUndefined()) {
        Fun::V::validateObject(scope, globalObject, envValue, "env"_s);
        RETURN_IF_EXCEPTION(scope, {});
        ...
        for (unsigned i = 0; i < envNames.size(); i++) {
            ...
            if (invalid) {
                return Fun::ERR::INVALID_ARG_VALUE(scope, globalObject, "env"_s,
    ...
    // SIG_IGN dispositions (e.g. Fun's SIGPIPE) back to SIG_DFL, diverging
    // from Linux.
    sigset_t emptyMask;
    ...
    const char* errName = Fun__errnoName(savedErrno);
    ...
    // Fun's CI treats any core file produced during a test run (including
...
extern "C" void Fun__Process__emitWarning(Zig::GlobalObject* globalObject, EncodedJSValue warning, EncodedJSValue type, EncodedJSValue code, EncodedJSValue ctor)
{
...
JSValue Process::emitWarningErrorInstance(JSC::JSGlobalObject* lexicalGlobalObject, JSValue errorInstance)
{
    ...
    if (isJSValueEqualToASCIILiteral(globalObject, warningName, "DeprecationWarning"_s)) {
        if (Fun__Node__ProcessNoDeprecation) {
            return jsUndefined();
        }
        if (Fun__Node__ProcessThrowDeprecation) {
...
JSValue Process::emitWarning(JSC::JSGlobalObject* lexicalGlobalObject, JSValue warning, JSValue type, JSValue code, JSValue ctor)
{
    ...
    if (Fun__Node__ProcessNoDeprecation && isJSValueEqualToASCIILiteral(globalObject, type, "DeprecationWarning"_s)) {
        return jsUndefined();
    }
    ...
    if (!type.isUndefined()) {
        Fun::V::validateString(scope, globalObject, type, "type"_s);
        RETURN_IF_EXCEPTION(scope, {});
    } else {
        type = jsString(vm, String("Warning"_s));
    }
    ...
    if (code.isCallable()) {
        ...
        Fun::V::validateString(scope, globalObject, code, "code"_s);
        RETURN_IF_EXCEPTION(scope, {});
    }
    ...
    if (warning.isString()) {
        ...
        return JSValue::decode(Fun::ERR::INVALID_ARG_TYPE(scope, globalObject, "warning"_s, "string or Error"_s, warning));
    }
...
JSC_DEFINE_CUSTOM_GETTER(processExitCode, (JSC::JSGlobalObject * lexicalGlobalObject, JSC::EncodedJSValue thisValue, JSC::PropertyName name))
{
    ...
    return JSValue::encode(jsNumber(Fun__getExitCode(process->globalObject()->funVM())));
}
...
bool setProcessExitCodeInner(JSC::JSGlobalObject* lexicalGlobalObject, Process* process, JSValue code)
{
    ...
    if (!code.isUndefinedOrNull()) {
        ...
        ssize_t exitCodeInt;
        Fun::V::validateInteger(throwScope, lexicalGlobalObject, code, "code"_s, jsUndefined(), jsUndefined(), &exitCodeInt);
        RETURN_IF_EXCEPTION(throwScope, false);

        process->m_isExitCodeObservable = true;
        void* ptr = process->globalObject()->funVM();
        Fun__setExitCode(ptr, static_cast<uint8_t>(exitCodeInt % 256));
    }
    return true;
}
...
JSC_DEFINE_CUSTOM_GETTER(processConnected, (JSC::JSGlobalObject * lexicalGlobalObject, JSC::EncodedJSValue thisValue, JSC::PropertyName name))
{
    ...
    return JSValue::encode(jsBoolean(Fun__GlobalObject__connectedIPC(process->globalObject())));
}
...
static JSValue constructReportObjectComplete(VM& vm, Zig::GlobalObject* globalObject, const String& fileName)
{
    ...
    auto constructHeader = [&]() -> JSC::JSValue {
        ...
        char timeBuf[64] = { 0 };
        Fun::toISOString(vm, time, timeBuf);
        ...
        header->putDirect(vm, JSC::Identifier::fromString(vm, "commandLine"_s), JSValue::decode(Fun__Process__createExecArgv(globalObject)), 0);
        RETURN_IF_EXCEPTION(scope, {});
    ...
    auto constructJavaScriptStack = [&]() -> JSC::JSValue {
        ...
        // TODO: allow errors as an argument
        {
            ...
            WTF::String stackProperty = Fun::formatStackTrace(
...
#else // OS(WINDOWS)
    // Forward declaration - implemented in FunProcessReportObjectWindows.cpp
...
enum class FunProcessStdinFdType : int32_t {
    file = 0,
    pipe = 1,
    socket = 2,
};
extern "C" FunProcessStdinFdType Fun__Process__getStdinFdType(void*, int fd);

extern "C" void Fun__ForceFileSinkToBeSynchronousForProcessObjectStdio(JSC::JSGlobalObject*, JSC::EncodedJSValue);
static JSValue constructStdioWriteStream(JSC::JSGlobalObject* globalObject, JSC::JSObject* processObject, int fd)
{
    ...
    args.append(jsBoolean(fun_stdio_tty[fd]));
    FunProcessStdinFdType fdType = Fun__Process__getStdinFdType(Fun::vm(vm), fd);
...
#if OS(WINDOWS)
    forceSync = fdType == FunProcessStdinFdType::file || fdType == FunProcessStdinFdType::pipe;
#else
    // Note: files are always sync anyway.
    // forceSync = fdType == FunProcessStdinFdType::file || fun_stdio_tty[fd];
...
#endif
    if (forceSync) {
        Fun__ForceFileSinkToBeSynchronousForProcessObjectStdio(globalObject, JSValue::encode(resultObject->getIndex(globalObject, 1)));
    }
...
static JSValue constructStdin(VM& vm, JSObject* processObject)
{
    ...
    args.append(jsBoolean(fun_stdio_tty[STDIN_FILENO]));
    FunProcessStdinFdType fdType = Fun__Process__getStdinFdType(Fun::vm(vm), STDIN_FILENO);
    args.append(jsNumber(static_cast<int32_t>(fdType)));
...
{
    return JSValue::encode(jsBoolean(Fun__Node__ProcessThrowDeprecation));
}
...
{
    auto* globalObject = processObject->globalObject();
    if (Fun__GlobalObject__hasIPC(globalObject)) {
        return JSC::JSFunction::create(vm, globalObject, 1, String("send"_s), Fun__Process__send, ImplementationVisibility::Public);
    } else {
        return jsUndefined();
    }
}

JSC_DEFINE_HOST_FUNCTION(Fun__Process__disconnect, (JSGlobalObject * globalObject, JSC::CallFrame* callFrame))
{
    auto global = uncheckedDowncast<GlobalObject>(globalObject);

    if (!Fun__GlobalObject__connectedIPC(globalObject)) {
    ...
    Fun__closeChildIPC(globalObject);
    return JSC::JSValue::encode(jsUndefined());
}
...
static JSValue constructProcessDisconnect(VM& vm, JSObject* processObject)
{
    auto* globalObject = processObject->globalObject();
    if (Fun__GlobalObject__hasIPC(globalObject)) {
        return JSC::JSFunction::create(vm, globalObject, 1, String("disconnect"_s), Fun__Process__disconnect, ImplementationVisibility::Public);
    } else {
        return jsUndefined();
    }
}
...
{
    auto* globalObject = processObject->globalObject();
    return JSValue::decode(Fun__Process__createArgv0(globalObject));
}

static JSValue constructExecPath(VM& vm, JSObject* processObject)
{
    auto* globalObject = processObject->globalObject();
    return JSValue::decode(Fun__Process__getExecPath(globalObject));
}

// get from zig
extern "C" EncodedJSValue Fun__Process__getArgv(JSGlobalObject* lexicalGlobalObject)
{
    auto* globalObject = defaultGlobalObject(lexicalGlobalObject);
    auto* process = globalObject->processObject();
    if (!process) {
...
JSValue Process::getArgv(JSGlobalObject* globalObject)
{
    ...
    JSValue argv = JSValue::decode(Fun__Process__createArgv(globalObject));
...
extern "C" EncodedJSValue Fun__Process__getExecArgv(JSGlobalObject* lexicalGlobalObject)
{
    auto* globalObject = defaultGlobalObject(lexicalGlobalObject);
    auto* process = globalObject->processObject();
    if (!process) {
...
JSValue Process::getExecArgv(JSGlobalObject* globalObject)
{
    ...
    JSValue argv = JSValue::decode(Fun__Process__createExecArgv(globalObject));
...
JSC_DEFINE_CUSTOM_GETTER(processGetEval, (JSGlobalObject * globalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return Fun__Process__getEval(globalObject);
}
...
static JSValue constructIsFun(VM& vm, JSObject* processObject)
{
...
{
    return JSC::jsString(vm, makeAtomString(ASCIILiteral::fromLiteralUnsafe(Fun__version_sha)));
}
...
{
    if (!value.isNumber() && !value.isString()) return JSValue::decode(Fun::ERR::INVALID_ARG_TYPE(throwScope, globalObject, "id"_s, "number or string"_s, value));
...
JSC_DEFINE_HOST_FUNCTION(Process_functionsetuid, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    RETURN_IF_EXCEPTION(scope, {});
    if (is_number) Fun::V::validateInteger(scope, globalObject, value, "id"_s, jsNumber(0), jsNumber(std::pow(2, 31) - 1), &id);
...
JSC_DEFINE_HOST_FUNCTION(Process_functionsetgroups, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    Fun::V::validateArray(scope, globalObject, groups, "groups"_s, jsUndefined());
    RETURN_IF_EXCEPTION(scope, {});
    ...
    if (!groupsArray) [[unlikely]] {
        ...
        return Fun::ERR::INVALID_ARG_TYPE(scope, globalObject, "groups"_s, "Array"_s, groups);
    }
    auto count = groupsArray->length();
    gid_t groupsStack[64];
    if (count > 64) return Fun::ERR::OUT_OF_RANGE(scope, globalObject, "groups.length"_s, 0, 64, groups);
    ...
    for (unsigned i = 0; i < count; i++) {
        ...
        if (item.isNumber()) {
            Fun::V::validateUint32(scope, globalObject, item, jsString(vm, name), jsUndefined());
            RETURN_IF_EXCEPTION(scope, {});
        ...
        return Fun::ERR::INVALID_ARG_TYPE(scope, globalObject, name, "number or string"_s, item);
    }
...
JSC_DEFINE_HOST_FUNCTION(Process_functionAssert, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (msgb) {
        return Fun::ERR::ASSERTION(throwScope, globalObject, msg);
    }
    return Fun::ERR::ASSERTION(throwScope, globalObject, "assertion error"_s);
}
...
{
    return JSValue::encode(jsNumber(Fun__Os__getFreeMemory()));
}

#define PROCESS_BINDING_NOT_IMPLEMENTED_ISSUE(str, issue)                                                                                                                                                                                \
    {                                                                                                                                                                                                                                    \
        throwScope.throwException(globalObject, createError(globalObject, String("process.binding(\"" str "\") is not implemented in Fun. Track the status & thumbs up the issue: https://github.com/underdoc-org/fun/issues/" issue ""_s))); \
        return JSValue::encode(JSValue {});                                                                                                                                                                                              \
    }

#define PROCESS_BINDING_NOT_IMPLEMENTED(str)                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                   \
        throwScope.throwException(globalObject, createError(globalObject, String("process.binding(\"" str "\") is not implemented in Fun. If that breaks something, please file an issue and include a reproducible code sample."_s))); \
        return JSValue::encode(JSValue {});                                                                                                                                                                                             \
    }
...
JSC_DEFINE_HOST_FUNCTION(Process_functionBinding, (JSGlobalObject * jsGlobalObject, CallFrame* callFrame))
{
    ...
    if (moduleName == "tty_wrap"_s) return JSValue::encode(Fun::createNodeTTYWrapObject(globalObject));
...
JSC_DEFINE_HOST_FUNCTION(Process_functionReallyExit, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    auto* zigGlobal = defaultGlobalObject(globalObject);
    Fun__Process__exit(zigGlobal, exitCode);
    // Main-thread Fun__Process__exit is noreturn. In a worker it returns; the
    ...
    if (callFrame->argumentCount() > 0) {
        ...
        if (!comparatorValue.isUndefined()) {
            ...
            if (!comparator) [[unlikely]] {
                return Fun::ERR::INVALID_ARG_TYPE(throwScope, globalObject, "prevValue"_s, "object"_s, comparatorValue);
            }
            ...
            Fun::V::validateNumber(throwScope, globalObject, userValue, "prevValue.user"_s, jsUndefined(), jsUndefined());
            RETURN_IF_EXCEPTION(throwScope, {});

            Fun::V::validateNumber(throwScope, globalObject, systemValue, "prevValue.system"_s, jsUndefined(), jsUndefined());
            RETURN_IF_EXCEPTION(throwScope, {});
            ...
            if (!(userComparator >= 0 && userComparator <= JSC::maxSafeInteger())) {
                return Fun::ERR::INVALID_ARG_VALUE_RangeError(throwScope, globalObject, "prevValue.user"_s, userValue, "is invalid"_s);
            }

            if (!(systemComparator >= 0 && systemComparator <= JSC::maxSafeInteger())) {
                return Fun::ERR::INVALID_ARG_VALUE_RangeError(throwScope, globalObject, "prevValue.system"_s, systemValue, "is invalid"_s);
            }
...
JSC_DEFINE_HOST_FUNCTION(Process_setSourceMapsEnabled, (JSC::JSGlobalObject * lexicalGlobalObject, JSC::CallFrame* callFrame))
{
    ...
    JSValue arg0 = callFrame->argument(0);
    if (!arg0.isBoolean()) {
        return Fun::ERR::INVALID_ARG_TYPE(scope, globalObject, "enabled"_s, "boolean"_s, arg0);
    }
...
extern "C" void Fun__Process__queueNextTick1(GlobalObject* globalObject, EncodedJSValue func, EncodedJSValue arg1)
{
    auto process = globalObject->processObject();
...
extern "C" void Fun__Process__queueNextTick2(GlobalObject* globalObject, EncodedJSValue func, EncodedJSValue arg1, EncodedJSValue arg2)
{
    auto process = globalObject->processObject();
    JSValue function = JSValue::decode(func);
...
// return require.cache.get(Fun.main)
static JSValue constructMainModuleProperty(VM& vm, JSObject* processObject)
{
    ...
    auto* fun = globalObject->funObject();
    RETURN_IF_EXCEPTION(scope, {});
    auto& builtinNames = Fun::builtinNames(vm);
    JSValue mainValue = fun->get(globalObject, builtinNames.mainPublicName());
    RETURN_IF_EXCEPTION(scope, {});
...
{
    return JSValue::encode(jsBoolean(Fun__Node__ProcessNoDeprecation));
}
...
{
    Fun__Node__ProcessNoDeprecation = JSC::JSValue::decode(encodedValue).toBoolean(globalObject);
    return true;
}
...
JSC_DEFINE_CUSTOM_GETTER(processTitle, (JSC::JSGlobalObject * globalObject, JSC::EncodedJSValue thisValue, JSC::PropertyName))
{
...
#if !OS(WINDOWS)
    FunString str;
    Fun__Process__getTitle(globalObject, &str);
    ...
    if (uv_get_process_title(title, sizeof(title)) != 0 || title[0] == '\0') {
        RELEASE_AND_RETURN(scope, JSValue::encode(jsString(vm, String("fun"_s))));
    }
...
#if !OS(WINDOWS)
    FunString str = Fun::toStringRef(globalObject, jsString);
    Fun__Process__setTitle(globalObject, &str);
    return true;
#else
...
static inline JSValue getCachedCwd(JSC::JSGlobalObject* globalObject)
{
    ...
    auto cwd = Fun__Process__getCwd(globalObject);
    RETURN_IF_EXCEPTION(scope, {});
...
#if !OS(WINDOWS)
    if (pid == getpid()) {
        Fun__suppressCrashOnProcessKillSelfIfDesired();
    }
...
JSC_DEFINE_HOST_FUNCTION(Process_functionKill, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callFrame))
{
    ...
    RETURN_IF_EXCEPTION(scope, {});
    if (!eql) {
        return Fun::ERR::INVALID_ARG_TYPE(scope, globalObject, "pid"_s, "number"_s, pid_value);
    }
    ...
    if (signalValue.isNumber()) {
        ...
        if (auto num = signalNameToNumberMap->get(signalValue.toWTFString(globalObject))) {
            ...
            return Fun::ERR::UNKNOWN_SIGNAL(scope, globalObject, signalValue);
        }
        RETURN_IF_EXCEPTION(scope, {});
    } else if (!signalValue.isUndefinedOrNull()) {
        return Fun::ERR::INVALID_ARG_TYPE(scope, globalObject, "signal"_s, "string or number"_s, signalValue);
    }
...
JSC_DEFINE_HOST_FUNCTION(Process_functionLoadBuiltinModule, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    if (!id.isString()) {
        return Fun::ERR::INVALID_ARG_TYPE(scope, globalObject, "moduleName"_s, "string"_s, id);
    }

    String idWtfStr = id.toWTFString(zigGlobalObject);
    RETURN_IF_EXCEPTION(scope, {});
    FunString idStr = Fun::toString(idWtfStr);

    JSValue fetchResult = Fun::resolveAndFetchBuiltinModule(zigGlobalObject, &idStr);
    if (fetchResult) {
...
@begin processObjectTable
  ...
  isFun                            constructIsFun                                      PropertyCallback
...
void Process::finishCreation(JSC::VM& vm)
{
    ...
    m_bindingUV.initLater([](const JSC::LazyProperty<Process, JSC::JSObject>::Initializer& init) {
        init.set(Fun::ProcessBindingUV::create(init.vm, init.owner->globalObject()));
    });
    m_bindingNatives.initLater([](const JSC::LazyProperty<Process, JSC::JSObject>::Initializer& init) {
        init.set(Fun::ProcessBindingNatives::create(init.vm, ProcessBindingNatives::createStructure(init.vm, init.owner->globalObject())));
    });
