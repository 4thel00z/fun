...
extern "C" int Fun__defaultRemainingRunsUntilSkipReleaseAccess;

extern "C" void Fun__JSC_onBeforeWait(JSC::VM* _Nonnull vm)
{
    ASSERT(vm);
    ...
    if (previouslyHadAccess) {
        ...
        // https://github.com/underdoc-org/fun/pull/14885 to regress due to
        ...
        // then don't bother.
        const int defaultRemainingRunsUntilSkipReleaseAccess = Fun__defaultRemainingRunsUntilSkipReleaseAccess;
