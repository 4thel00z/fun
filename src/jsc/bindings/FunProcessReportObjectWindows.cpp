...
#include "headers.h" // For Fun__Process__createExecArgv and other exports
...
// External functions
extern "C" EncodedJSValue Fun__Process__createExecArgv(JSGlobalObject*);
...
JSValue constructReportObjectWindows(VM& vm, Zig::GlobalObject* globalObject, Process* process)
{
    ...
    // Header section
    {
        ...
        // Command line
        header->putDirect(vm, Identifier::fromString(vm, "commandLine"_s), JSValue::decode(Fun__Process__createExecArgv(globalObject)), 0);
        RETURN_IF_EXCEPTION(scope, {});
