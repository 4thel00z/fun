...
// argument to Fun.markdown.render() callbacks. These have fixed shapes
...
extern "C" JSC::EncodedJSValue FunMarkdownMeta__createListItem(
...
extern "C" JSC::EncodedJSValue FunMarkdownMeta__createList(
    JSGlobalObject* globalObject,
    bool ordered,
    EncodedJSValue start, // jsNumber or jsUndefined
    uint32_t depth);
...
extern "C" JSC::EncodedJSValue FunMarkdownMeta__createCell(
    JSGlobalObject* globalObject,
...
extern "C" JSC::EncodedJSValue FunMarkdownMeta__createLink(
    JSGlobalObject* globalObject,
    EncodedJSValue href,
