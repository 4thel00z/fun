//! JSC bridges for `fun.http.{Headers,H2Client,H3Client}`. Keeps `src/http/`
//! free of JSC types.

pub fn toFetchHeaders(this: *Headers, global: *fun.jsc.JSGlobalObject) fun.JSError!*FetchHeaders {
    ...
    const headers = FetchHeaders.create(
        ...
        &fun.ZigString.fromBytes(this.buf.items),
...
pub const H2TestingAPIs = struct {
    pub fn liveCounts(globalThis: *jsc.JSGlobalObject, _: *jsc.CallFrame) fun.JSError!jsc.JSValue {
...
pub const H3TestingAPIs = struct {
    ...
    pub fn quicLiveCounts(globalThis: *jsc.JSGlobalObject, _: *jsc.CallFrame) fun.JSError!jsc.JSValue {
        const obj = jsc.JSValue.createEmptyObject(globalThis, 2);
