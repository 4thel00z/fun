...
pub fn ErrorBuilder(comptime code: Error, comptime fmt: [:0]const u8, Args: type) type {
  return struct {
      ...
      pub inline fn throw(this: @This()) fun.JSError {
...
zig += `
  ...
  extern fn Fun__createErrorWithCode(globalThis: *jsc.JSGlobalObject, code: Error, message: *fun.String) jsc.JSValue;
  ...
  pub fn toJS(this: Error, globalThis: *jsc.JSGlobalObject, message: *fun.String) jsc.JSValue {
    defer message.deref();
    return Fun__createErrorWithCode(globalThis, this, message);
  }

  pub fn fmt(this: Error, globalThis: *jsc.JSGlobalObject, comptime fmt_str: [:0]const u8, args: anytype) jsc.JSValue {
    if (comptime std.meta.fieldNames(@TypeOf(args)).len == 0) {
      var message = fun.String.static(fmt_str);
      return toJS(this, globalThis, &message);
    }

    var message = fun.handleOom(fun.String.createFormat(fmt_str, args));
    return toJS(this, globalThis, &message);
  }

  pub fn throw(this: Error, globalThis: *jsc.JSGlobalObject, comptime fmt_str: [:0]const u8, args: anytype) fun.JSError {
...
let builtindts = await Fun.file(builtindtsPath).text();
