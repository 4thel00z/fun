    ...
    for (alphabetized_names) |i| {
        ...
        // "@babel/core@7.9.0":
        {
            ...
            for (dependency_versions) |*dependency_version| {
                ...
                const needs_quote = always_needs_quote or fun.strings.indexAnyComptime(version_name, " |\t-/!:") != null or strings.hasPrefixComptime(version_name, "npm:");
...
const Printer = fun.install.Lockfile.Printer;
