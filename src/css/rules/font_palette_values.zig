...
pub const BasePalette = union(enum) {
    ...
    pub fn parse(input: *css.Parser) Result(BasePalette) {
        ...
        if (fun.strings.eqlCaseInsensitiveASCIIICheckLength("light", ident)) {
            return .{ .result = .light };
        } else if (fun.strings.eqlCaseInsensitiveASCIIICheckLength("dark", ident)) {
            return .{ .result = .dark };
...
pub const FontPaletteValuesDeclarationParser = struct {
    ...
    pub const DeclarationParser = struct {
        ...
        pub fn parseValue(this: *This, name: []const u8, input: *css.Parser) Result(Declaration) {
            ...
            if (fun.strings.eqlCaseInsensitiveASCIIICheckLength("font-family", name)) {
            ...
            } else if (fun.strings.eqlCaseInsensitiveASCIIICheckLength("base-palette", name)) {
            ...
            } else if (fun.strings.eqlCaseInsensitiveASCIIICheckLength("override-colors", name)) {
