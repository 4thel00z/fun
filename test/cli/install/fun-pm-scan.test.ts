...
describe("fun pm scan", () => {
  describe("configuration", () => {
    ...
    test("shows error when lockfile doesn't exist", async () => {
      ...
      expect(stderr).toContain("Run 'fun install' first");
    });
  ...
  describe("output formatting", () => {
    ...
    test("shows timing for slow scans", async () => {
      ...
      const proc = Fun.spawn({
        ...
        stdout: "pipe",
        stderr: "pipe",
        env: { ...funEnv, FUN_DEBUG_QUIET_LOGS: "0" }, // Enable timing output
      });
  ...
  describe("differences from fun add/install", () => {
