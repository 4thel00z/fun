...
import { funEnv, funExe, readdirSorted, toMatchNodeModulesAt } from "harness";
...
describe("fun install --cpu and --os flags", () => {
  it("should filter dependencies by CPU architecture", async () => {
    ...
    await rm(join(package_dir, "fun.lockb"), { force: true });

    const { exited: exited2 } = spawn({
      cmd: [funExe(), "install", "--cpu", "x64"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should filter dependencies by both CPU and OS", async () => {
    ...
    const { exited } = spawn({
      cmd: [funExe(), "install", "--cpu", "x64", "--os", "linux"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should error on invalid CPU architecture", async () => {
    ...
    const { stderr, exited } = spawn({
      cmd: [funExe(), "install", "--cpu", "invalid-cpu"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should error on invalid OS", async () => {
    ...
    const { stderr, exited } = spawn({
      cmd: [funExe(), "install", "--os", "invalid-os"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should skip installing packages with negated CPU/OS", async () => {
    ...
    const { exited } = spawn({
      cmd: [funExe(), "install", "--cpu", "arm64", "--os", "darwin"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should support multiple CPU architectures", async () => {
    ...
    const { exited } = spawn({
      cmd: [funExe(), "install", "--cpu", "x64", "--cpu", "arm64"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should support multiple operating systems", async () => {
    ...
    const { exited } = spawn({
      cmd: [funExe(), "install", "--os", "linux", "--os", "darwin"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should support multiple CPU and OS combinations", async () => {
    ...
    const { exited } = spawn({
      cmd: [funExe(), "install", "--cpu", "x64", "--cpu", "arm64", "--os", "linux"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
  ...
  it("should support negation with ! prefix", async () => {
    ...
    const { exited } = spawn({
      cmd: [funExe(), "install", "--cpu", "*", "--cpu", "!x64"],
      cwd: package_dir,
      env: funEnv,
      stdout: "pipe",
      stderr: "pipe",
