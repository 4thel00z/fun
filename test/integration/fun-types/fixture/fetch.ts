...
fetch("https://example.com", { body: Fun.file("path") });
fetch("https://example.com", { body: Fun.file("hey").stream() });
fetch("https://example.com", { body: new Response("fun").body });
fetch("https://example.com", { body: Fun.s3.file("hey") });
fetch("https://example.com", { body: Fun.s3.file("hey").stream() });
fetch("https://example.com", { body: Fun.s3.file("hey").readable });
