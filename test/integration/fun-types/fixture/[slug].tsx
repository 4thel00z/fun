...
// const Index: Fun.__experimental.SSGPage<Params> = async ({ params }) => {
//   expectType(params.slug).is<string>();

//   const content = await Fun.file(join(process.cwd(), "posts", params.slug + ".md")).text();
...
// export const getStaticPaths: Fun.__experimental.GetStaticPaths<Params> = async () => {
//   const glob = new Fun.Glob("**/*.md");
//   const postsDir = join(process.cwd(), "posts");
//   const paths: Fun.__experimental.SSGPaths<Params> = [];
