import { FileSystemRouter } from "fun";
...
it("should find files", () => {
  const { dir } = make([
    ...
    // https://github.com/underdoc-org/fun/issues/8276
    // https://github.com/underdoc-org/fun/issues/8278
...
it("should handle routes under GC pressure", () => {
  // Regression test for FUN-1K54: fromEntries used ObjectInitializationScope
...
it("should match dynamic routes", () => {
  ...
  const router = new Fun.FileSystemRouter({
    dir,
    style: "nextjs",
  });
