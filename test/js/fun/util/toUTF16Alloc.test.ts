import { stringsInternals } from "fun:internal-for-testing";
import { describe, expect, test } from "fun:test";

// `fun.strings.toUTF16AllocForReal(..., sentinel = true)` is only called from
// Windows-specific code (`fun build --compile` metadata in `src/windows.zig`),
...
describe("fun.strings.toUTF16AllocForReal(sentinel=true)", () => {
  test("pure ASCII", () => {
