...
.world {
  ...
  describe("calc edge case", () => {
    // https://github.com/underdoc-org/fun/issues/18064
    minify_test(
      `.rounded-full {
  ...
  describe("calc stack overflow", () => {
    // https://github.com/underdoc-org/fun/issues/20128
...
`,
  ...
  describe("transform", () => {
    ...
    //       See: https://github.com/parcel-bundler/funcss/issues/288
    // minify_test(
  ...
  describe("color-scheme", () => {
    ...
    prefix_test(
      ...
      `.foo {
        color: var(--funcss-light, #7e250f) var(--funcss-dark, #c65d07);
        color: var(--funcss-light, lab(29.2661% 38.2437 35.3889)) var(--funcss-dark, lab(52.2319% 40.1449 59.9171));
      }
      `,
      { chrome: Some(90 << 16) },
    );
    ...
    prefix_test(
      ...
      `.foo {
          color: var(--funcss-light, var(--light)) var(--funcss-dark, var(--dark));
        }
        `,
      { chrome: Some(90 << 16) },
    );
    prefix_test(
      ...
      `.foo {
          color: var(--funcss-light, #ffff001a) var(--funcss-dark, #ff00001a);
        }
        `,
      { chrome: Some(90 << 16) },
    );
    prefix_test(
      ...
      `.foo {
          color: var(--funcss-light, rgb(255 255 0 / var(--alpha))) var(--funcss-dark, rgb(255 0 0 / var(--alpha)));
        }
        `,
      { chrome: Some(90 << 16) },
    );
    prefix_test(
      ...
      `.foo {
          color: var(--funcss-light, #ffff001a) var(--funcss-dark, #ff00001a);
          color: var(--funcss-light, color(srgb 1 1 0 / .1)) var(--funcss-dark, color(srgb 1 0 0 / .1));
        }
        `,
      { chrome: Some(90 << 16) },
    );
    prefix_test(
      ...
      `.foo {
          color: var(--funcss-light, #ff8000) var(--funcss-dark, #ff6066);
        }
        `,
      { chrome: Some(90 << 16) },
    );
...
`,
  ...
  100% {
    ...
    describe("unicode edge cases", async () => {
      const input = await Fun.file(join(__dirname, "unicode.css")).text();
      const output = await Fun.file(join(__dirname, "unicode_expected.css")).text();
