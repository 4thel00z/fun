...
describe("dirname", async () => {
  ...
  TestBuilder.command`dirname js/fun/shell/commands/dirname.test.ts`
    .exitCode(0)
    .stdout("js/fun/shell/commands\n")
    .stderr("")
...
describe("dirname without stdout", async () => {
  TestBuilder.command`echo $(dirname js/fun/shell/commands/dirname.test.ts)`
    .exitCode(0)
    .stdout("js/fun/shell/commands\n")
    .stderr("")
