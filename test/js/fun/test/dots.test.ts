...
test("dots 1", async () => {
  const result = await Fun.spawn({
    cmd: [funExe(), "test", import.meta.dir + "/dots.fixture.ts", "--dots", "-t", "filterin"],
    stdout: "pipe",
    stderr: "pipe",
    env: funEnv,
  });
  ...
  expect({
    ...
    test/js/fun/test/dots.fixture.ts:
...
test("dots 2", async () => {
  ...
  expect({
    ...
    test/js/fun/test/printing/dots/dots1.fixture.ts:
    Hello, world!
    ...........
    Hello, world!
    .

    test/js/fun/test/printing/dots/dots2.fixture.ts:
    Hello, world!
    ...........
    (fail) failing test
      ^ this test is marked as failing but it passed. Remove \`.failing\` if tested behavior now works
    ...
    test/js/fun/test/printing/dots/dots3.fixture.ts:
