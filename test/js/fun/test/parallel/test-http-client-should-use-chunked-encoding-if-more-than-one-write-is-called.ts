...
// Fun.serve is used here until #15576 or similar fix is merged
...
expect(chunks[chunks.length - 1]?.toString()).toEndWith("FUN!");
expect(Buffer.concat(chunks).toString()).toBe("chunk ".repeat(4) + "FUN!");
