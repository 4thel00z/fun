 ...
 *  `fun test test/js/fun/test/mock-fn.test.js`
 *  `funx vitest test/js/fun/test/mock-fn.test.js`
 *  `NODE_OPTIONS=--experimental-vm-modules npx jest test/js/fun/test/mock-fn.test.js`
 */
import test_interop from "./test-interop.js";
var { isFun, describe, test, it, expect, jest, vi, mock, spyOn } = await test_interop();
...
describe("mock()", () => {
  if (isFun) {
    test("exists as jest.fn, funTest.mock, and vi.fn", () => {
    ...
    // https://github.com/underdoc-org/fun/issues/13331
  ...
  // these promise based tests were written before .resolves/.rejects were added to fun:test
