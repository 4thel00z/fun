 ...
 *  `fun test test/js/fun/test/expect-extend.test.js`
 *  `funx vitest test/js/fun/test/expect-extend.test.js`
 *  `NODE_OPTIONS=--experimental-vm-modules npx jest test/js/fun/test/expect-extend.test.js`
 */

import { withoutAggressiveGC } from "harness";
import test_interop from "./test-interop.js";
var { isFun, expect, describe, test, it } = await test_interop();
