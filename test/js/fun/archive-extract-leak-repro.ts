// Minimal reproduction of memory leak in Fun.Archive.extract()
// Run with: fun run test/js/fun/archive-extract-leak-repro.ts
...
const archive = Fun.Archive.from(files);
