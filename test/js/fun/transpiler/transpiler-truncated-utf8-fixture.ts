...
import { dlopen, ptr, toArrayBuffer } from "fun:ffi";
...
const libcPath = process.env.FUN_TEST_LIBC_PATH!;
if (!libcPath) throw new Error("FUN_TEST_LIBC_PATH not set");
...
// MAP_FAILED = (void*)-1 marshals through fun:ffi's `ptr` return as
...
const tp = new Fun.Transpiler({ loader: "js" });
