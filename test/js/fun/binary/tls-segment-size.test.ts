...
// ~50 `threadlocal var x: fun.PathBuffer` were moved behind
// `fun.ThreadlocalBuffers`.
//
// PE/COFF has no TLS-BSS, so on Windows each of those buffers (96 KB
// apiece there) used to be written into fun.exe as raw zeros — ~5 MB of
