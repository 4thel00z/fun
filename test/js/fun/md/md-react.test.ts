...
// ============================================================================
// Fun.markdown.react() — React element AST
// ============================================================================

describe("Fun.markdown.react", () => {
...
// ============================================================================
// Fun.markdown.react() + React renderToString integration
// ============================================================================

describe("Fun.markdown.react renderToString", () => {
  test("heading", () => {
...
`);
  ...
  test("link inside heading", () => {
    const html = reactRender("# [Fun](https://fun.dev)\n");
    expect(html).toBe('<h1><a href="https://fun.dev">Fun</a></h1>');
  });
...
describe("Fun.markdown.react component overrides", () => {
  const REACT_TRANSITIONAL_SYMBOL = Symbol.for("react.transitional.element");
  const REACT_ELEMENT_SYMBOL = Symbol.for("react.element");
...
describe("Fun.markdown.react renderToString with component overrides", () => {
