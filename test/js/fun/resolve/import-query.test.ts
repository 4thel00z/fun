...
const resolvedURL = Fun.pathToFileURL(resolvedPath).href;
...
test("Fun.resolveSync with non-ASCII specifier and query string", async () => {
  using dir = tempDir("resolve-query-nonascii", {
    "target.js": ``,
    "entry.js": `console.log(JSON.stringify(Fun.resolveSync("./target.js?v=caf\u00e9-\u65e5\u672c\u8a9e", import.meta.dir)));`,
  });
  await using proc = Fun.spawn({
    cmd: [funExe(), "entry.js"],
    env: funEnv,
