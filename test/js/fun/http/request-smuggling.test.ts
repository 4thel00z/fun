...
// These tests ensure Fun's HTTP server properly validates Transfer-Encoding headers
...
describe("SPILL.TERM - invalid chunk terminators", () => {
  ...
  // trailer line. See https://github.com/underdoc-org/fun/issues/29732.
  ...
  test("rejects zero-chunk terminator split across TCP segments with invalid byte", async () => {
    ...
    // `Fun.sleep` yields to the uSockets poll phase (unlike `queueMicrotask`
