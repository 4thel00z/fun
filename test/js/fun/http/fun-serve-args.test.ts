...
describe("Fun.serve basic options", () => {
...
describe("Fun.serve error handling", () => {
...
describe("Fun.serve websocket options", () => {
...
describe("Fun.serve development options", () => {
  ...
  // The `inspector` option was removed from Fun.serve(). It used to register a
  // `/fun:inspect` WebSocket route and throw when combined with
...
describe("Fun.serve static routes", () => {
...
describe("Fun.serve unix socket", () => {
...
describe("Fun.serve hostname and port validation", () => {
...
describe("Fun.serve hostname coercion", () => {
...
describe("Fun.serve unix socket validation", () => {
