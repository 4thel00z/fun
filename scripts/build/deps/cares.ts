...
// Android: enables ares_sysconfig's net.dns1..4 fallback when JNI is unavailable.
// prettier-ignore
const ANDROID = def1([
...
// prettier-ignore
const FREEBSD = def1([
  "HAVE_SYS_EVENT_H", "HAVE_SYS_RANDOM_H", "HAVE_SYS_SOCKIO_H",
  "HAVE_KQUEUE", "HAVE_ARC4RANDOM_BUF", "HAVE_GETRANDOM",
  "HAVE_MSG_NOSIGNAL", "HAVE_PIPE2",
  "HAVE_GETSERVBYPORT_R", "HAVE_GETSERVBYNAME_R",
]);
