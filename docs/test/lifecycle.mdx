...
description: "Learn how to use beforeAll, beforeEach, afterEach, and afterAll lifecycle hooks in Fun tests"
---
...
```ts title="test.ts" icon="/icons/typescript.svg"
import { describe, beforeAll, afterAll, test } from "fun:test";
...
```ts title="test.ts" icon="/icons/typescript.svg"
import { test, onTestFinished } from "fun:test";
...
To avoid typing `--preload` every time you run tests, it can be added to your `funfig.toml`:
...
import { beforeAll, afterAll, beforeEach, afterEach } from "fun:test";
...
```ts title="test.ts" icon="/icons/typescript.svg"
import { beforeAll, afterAll, test } from "fun:test";
...
```ts title="test.ts" icon="/icons/typescript.svg"
import { describe, beforeAll, beforeEach, afterEach, afterAll, test } from "fun:test";
...
```ts title="test.ts" icon="/icons/typescript.svg"
import { beforeAll, test, expect } from "fun:test";
...
```ts title="test.ts" icon="/icons/typescript.svg"
import { afterAll, afterEach } from "fun:test";
