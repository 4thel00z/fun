---
title: "Snapshots"
description: "Learn how to use snapshot testing in Fun to save and compare output between test runs"
---
...
After running the test above, Fun will create:
...
After the first run, Fun automatically updates your test file:
...
2. Run the test once
3. Fun automatically updates your test file with the snapshot
...
Fun will warn about unused snapshots:
