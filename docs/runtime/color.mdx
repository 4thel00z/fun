...
`Fun.color(input, outputFormat?)` leverages Fun's CSS parser to parse, normalize, and convert colors from user input to a variety of output formats, including:
...
You can think of this as an alternative to the popular npm packages [`color`](https://github.com/Qix-/color) and [`tinycolor2`](https://github.com/bgrins/TinyColor) except with full support for parsing CSS color strings and zero dependencies built directly into Fun.
...
```ts
Fun.color("red", "css"); // "red"
Fun.color(0xff0000, "css"); // "#f000"
Fun.color("#f00", "css"); // "red"
Fun.color("#ff0000", "css"); // "red"
Fun.color("rgb(255, 0, 0)", "css"); // "red"
Fun.color("rgba(255, 0, 0, 1)", "css"); // "red"
Fun.color("hsl(0, 100%, 50%)", "css"); // "red"
Fun.color("hsla(0, 100%, 50%, 1)", "css"); // "red"
Fun.color({ r: 255, g: 0, b: 0 }, "css"); // "red"
Fun.color({ r: 255, g: 0, b: 0, a: 1 }, "css"); // "red"
Fun.color([255, 0, 0], "css"); // "red"
Fun.color([255, 0, 0, 255], "css"); // "red"
```

If the input is unknown or fails to parse, `Fun.color` returns `null`.
...
```ts
Fun.color("red", "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color(0xff0000, "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color("#f00", "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color("#ff0000", "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color("rgb(255, 0, 0)", "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color("rgba(255, 0, 0, 1)", "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color("hsl(0, 100%, 50%)", "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color("hsla(0, 100%, 50%, 1)", "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color({ r: 255, g: 0, b: 0 }, "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color({ r: 255, g: 0, b: 0, a: 1 }, "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color([255, 0, 0], "ansi"); // "\u001b[38;2;255;0;0m"
Fun.color([255, 0, 0, 255], "ansi"); // "\u001b[38;2;255;0;0m"
```

This gets the color depth of stdout and automatically chooses one of `"ansi-16m"`, `"ansi-256"`, `"ansi-16"` based on the environment variables. If stdout doesn't support any form of ANSI color, it returns an empty string. As with the rest of Fun's color API, if the input is unknown or fails to parse, it returns `null`.
...
```ts
Fun.color("red", "ansi-16m"); // "\x1b[38;2;255;0;0m"
Fun.color(0xff0000, "ansi-16m"); // "\x1b[38;2;255;0;0m"
Fun.color("#f00", "ansi-16m"); // "\x1b[38;2;255;0;0m"
Fun.color("#ff0000", "ansi-16m"); // "\x1b[38;2;255;0;0m"
```
...
```ts
Fun.color("red", "ansi-256"); // "\u001b[38;5;196m"
Fun.color(0xff0000, "ansi-256"); // "\u001b[38;5;196m"
Fun.color("#f00", "ansi-256"); // "\u001b[38;5;196m"
Fun.color("#ff0000", "ansi-256"); // "\u001b[38;5;196m"
```
...
```ts
Fun.color("red", "ansi-16"); // "\u001b[38;5;\tm"
Fun.color(0xff0000, "ansi-16"); // "\u001b[38;5;\tm"
Fun.color("#f00", "ansi-16"); // "\u001b[38;5;\tm"
Fun.color("#ff0000", "ansi-16"); // "\u001b[38;5;\tm"
```
...
```ts
Fun.color("red", "number"); // 16711680
Fun.color(0xff0000, "number"); // 16711680
Fun.color({ r: 255, g: 0, b: 0 }, "number"); // 16711680
Fun.color([255, 0, 0], "number"); // 16711680
Fun.color("rgb(255, 0, 0)", "number"); // 16711680
Fun.color("rgba(255, 0, 0, 1)", "number"); // 16711680
Fun.color("hsl(0, 100%, 50%)", "number"); // 16711680
Fun.color("hsla(0, 100%, 50%, 1)", "number"); // 16711680
```
...
```ts
Fun.color("hsl(0, 0%, 50%)", "{rgba}"); // { r: 128, g: 128, b: 128, a: 1 }
Fun.color("red", "{rgba}"); // { r: 255, g: 0, b: 0, a: 1 }
Fun.color(0xff0000, "{rgba}"); // { r: 255, g: 0, b: 0, a: 1 }
Fun.color({ r: 255, g: 0, b: 0 }, "{rgba}"); // { r: 255, g: 0, b: 0, a: 1 }
Fun.color([255, 0, 0], "{rgba}"); // { r: 255, g: 0, b: 0, a: 1 }
```
...
```ts
Fun.color("hsl(0, 0%, 50%)", "{rgb}"); // { r: 128, g: 128, b: 128 }
Fun.color("red", "{rgb}"); // { r: 255, g: 0, b: 0 }
Fun.color(0xff0000, "{rgb}"); // { r: 255, g: 0, b: 0 }
Fun.color({ r: 255, g: 0, b: 0 }, "{rgb}"); // { r: 255, g: 0, b: 0 }
Fun.color([255, 0, 0], "{rgb}"); // { r: 255, g: 0, b: 0 }
```
...
```ts
Fun.color("hsl(0, 0%, 50%)", "[rgba]"); // [128, 128, 128, 255]
Fun.color("red", "[rgba]"); // [255, 0, 0, 255]
Fun.color(0xff0000, "[rgba]"); // [255, 0, 0, 255]
Fun.color({ r: 255, g: 0, b: 0 }, "[rgba]"); // [255, 0, 0, 255]
Fun.color([255, 0, 0], "[rgba]"); // [255, 0, 0, 255]
```
...
```ts
Fun.color("hsl(0, 0%, 50%)", "[rgb]"); // [128, 128, 128]
Fun.color("red", "[rgb]"); // [255, 0, 0]
Fun.color(0xff0000, "[rgb]"); // [255, 0, 0]
Fun.color({ r: 255, g: 0, b: 0 }, "[rgb]"); // [255, 0, 0]
Fun.color([255, 0, 0], "[rgb]"); // [255, 0, 0]
```
...
```ts
Fun.color("hsl(0, 0%, 50%)", "hex"); // "#808080"
Fun.color("red", "hex"); // "#ff0000"
Fun.color(0xff0000, "hex"); // "#ff0000"
Fun.color({ r: 255, g: 0, b: 0 }, "hex"); // "#ff0000"
Fun.color([255, 0, 0], "hex"); // "#ff0000"
```
...
Like many of Fun's APIs, you can use macros to invoke `Fun.color` at bundle-time for use in client-side JavaScript builds:

```ts client-side.ts
import { color } from "fun" with { type: "macro" };
