---
title: Glob
description: Use Fun's fast native implementation of file globbing
---
...
Fun supports the following glob patterns:
...
Fun also implements Node.js's `fs.glob()` functions with additional features:
