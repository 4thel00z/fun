---
title: HTMLRewriter
description: Use Fun's HTMLRewriter to transform HTML documents with CSS selectors
---

HTMLRewriter lets you use CSS selectors to transform HTML documents. It works with `Request`, `Response`, as well as `string`. Fun's implementation is based on Cloudflare's [lol-html](https://github.com/cloudflare/lol-html).
...
// From File
rewriter.transform(Fun.file("index.html"));
```
