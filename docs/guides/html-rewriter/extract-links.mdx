...
async function extractLinks(url: string) {
  ...
  console.log([...links]); // ["https://fun.dev", "/docs", ...]
}

// Extract all links from the Fun website
await extractLinks("https://fun.dev");
```
...
See [Docs > API > HTMLRewriter](/runtime/html-rewriter) for complete documentation on HTML transformation with Fun.
