...
// Example usage
const metadata = await extractSocialMetadata("https://fun.dev");
console.log(metadata);
// {
//   title: "Fun — A fast all-in-one JavaScript runtime",
//   description: "Bundle, transpile, install and run JavaScript & TypeScript projects — all in Fun. Fun is a fast all-in-one JavaScript runtime & toolkit designed for speed, complete with a bundler, test runner, and Node.js-compatible package manager.",
//   image: "https://fun.dev/share.jpg",
//   type: "website",
//   ...
// }
```
