---
title: Spy on methods in `fun test`
sidebarTitle: Spy on methods
mode: center
---

Use the `spyOn` utility to track method calls with Fun's test runner.
...
See [Docs > Test Runner > Mocks](/test/mocks) for complete documentation on mocking with the Fun test runner.
