---
title: Build an app with SolidStart and Fun
sidebarTitle: "SolidStart with Fun"
mode: center
---
...
fun create solid my-app --solidstart --ts
```
...
Then run the development server with `fun dev`.
