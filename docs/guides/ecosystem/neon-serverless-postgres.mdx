...
sidebarTitle: Neon Serverless Postgres with Fun
mode: center
---
...
Get started by creating a project directory, initializing the directory using `fun init`, and adding the [Neon serverless driver](https://github.com/neondatabase/serverless/) as a project dependency.

```sh terminal icon="terminal"
mkdir fun-neon-postgres
cd fun-neon-postgres
fun init -y
fun add @neondatabase/serverless
```
...
Start the program using `fun ./index.ts`. The Postgres version should be printed to the console.
