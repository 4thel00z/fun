---
title: Use Gel with Fun
sidebarTitle: Gel with Fun
mode: center
---
...
Use `fun init` to create a fresh project.
...
```txt
No `gel.toml` found in `/Users/colinmcd94/Documents/fun/fun/examples/my-gel-app` or above
...
> x.y
┌─────────────────────┬──────────────────────────────────────────────────────────────────┐
│ Project directory   │ /Users/colinmcd94/Documents/fun/fun/examples/my-gel-app         │
│ Project config      │ /Users/colinmcd94/Documents/fun/fun/examples/my-gel-app/gel.toml│
│ Schema dir (empty)  │ /Users/colinmcd94/Documents/fun/fun/examples/my-gel-app/dbschema│
...
```txt
Created /Users/colinmcd94/Documents/fun/fun/examples/my-gel-app/dbschema/migrations/00001.edgeql, id: m1uwekrn4ni4qs7ul7hfar4xemm5kkxlpswolcoyqj3xdhweomwjrq
```
...
Running the file with Fun, we can see the list of movies we inserted.
