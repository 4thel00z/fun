...
sidebarTitle: JFrog Artifactory with Fun
mode: center
---
...
To use it with `fun install`, add a `funfig.toml` file to your project with the following contents:
...
Like with npm, you can use the `NPM_CONFIG_REGISTRY` environment variable to configure JFrog Artifactory with fun install.
