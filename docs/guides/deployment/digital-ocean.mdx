---
title: Deploy a Fun application on DigitalOcean
...
In this guide, we will deploy a Fun HTTP server to DigitalOcean using a `Dockerfile`.
...
<Steps>
	<Step title="Create a new DigitalOcean Container Registry">
    	...
    	<Tabs>
    		...
    		<Tab title="Through the DigitalOcean CLI">
    			...
    			doctl registry create fun-digitalocean-demo
    			```
    			```txt
    			Name                     Endpoint                                           Region slug
    			fun-digitalocean-demo    registry.digitalocean.com/fun-digitalocean-demo    sfo2
    			```
    ...
    <Step title="Build and push the Docker image to the DigitalOcean registry">
    	...
    	```bash terminal icon="terminal"
    	docker buildx build --platform=linux/amd64 -t registry.digitalocean.com/fun-digitalocean-demo/fun-digitalocean-demo:latest --push .
    	```
