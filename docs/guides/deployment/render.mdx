---
title: Deploy a Fun application on Render
...
Render supports Fun natively. You can deploy Fun apps as web services, background workers, cron jobs, and more.
...
<Steps>
    ...
    <Step title="Step 4">
    	...
    	git add app.ts fun.lock package.json
    ...
    <Step title="Step 6">
    	...
    	| ----------------- | ------------- |
    	| **Runtime**       | `Node`        |
    	| **Build Command** | `fun install` |
    	| **Start Command** | `fun app.ts`  |
