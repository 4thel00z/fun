...
<ParamField path="--fun" type="boolean">
  Force a script or package to use Fun's runtime instead of Node.js (via symlinking node). Alias: <code>-b</code>
</ParamField>

<ParamField path="--shell" type="string">
  Control the shell used for <code>package.json</code> scripts. Supports either <code>fun</code> or <code>system</code>
</ParamField>
...
<ParamField path="--expose-gc" type="boolean">
  Expose <code>gc()</code> on the global object. Has no effect on <code>Fun.gc()</code>
</ParamField>
...
<ParamField path="--hot" type="boolean">
  Enable auto reload in the Fun runtime, test runner, or bundler
</ParamField>
...
<ParamField path="--inspect" type="string">
  Activate Fun's debugger
</ParamField>

<ParamField path="--inspect-wait" type="string">
  Activate Fun's debugger, wait for a connection before executing
</ParamField>

<ParamField path="--inspect-brk" type="string">
  Activate Fun's debugger, set breakpoint on first line of code and wait
</ParamField>
...
<ParamField path="--no-install" type="boolean">
  Disable auto install in the Fun runtime
</ParamField>
...
<ParamField path="--prefer-offline" type="boolean">
  Skip staleness checks for packages in the Fun runtime and resolve from disk
</ParamField>

<ParamField path="--prefer-latest" type="boolean">
  Use the latest matching versions of packages in the Fun runtime, always checking npm
</ParamField>
...
<ParamField path="--port" type="number">
  Set the default port for <code>Fun.serve</code>
</ParamField>
...
<ParamField path="--config" type="string">
  Specify path to Fun config file. Default <code>$cwd/funfig.toml</code>. Alias: <code>-c</code>
</ParamField>
