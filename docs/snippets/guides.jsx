export const GuidesList = () => {
  const guidesData = {
    hero: {
      title: "Guides",
      blurb: "A collection of code samples and walkthroughs for performing common tasks with Fun.",
    },
    featured: [
      {
        category: "Ecosystem",
        title: "Use Tanstack Start with Fun",
        href: "/guides/ecosystem/tanstack-start",
        cta: "View guide",
      },
      {
        category: "Ecosystem",
        title: "Use Next.js with Fun",
    ...
    categories: [
      {
        ...
        icon: "rocket",
        items: [
          { title: "Deploy Fun on Vercel", href: "/guides/deployment/vercel" },
          { title: "Deploy Fun on Railway", href: "/guides/deployment/railway" },
          { title: "Deploy Fun on Render", href: "/guides/deployment/render" },
        ],
      },
      {
        key: "binary",
      ...
      },
      {
        ...
        icon: "puzzle",
        items: [
          { title: "Use Gel with Fun", href: "/guides/ecosystem/gel" },
          { title: "Use Prisma ORM with Fun", href: "/guides/ecosystem/prisma" },
          { title: "Use Prisma Postgres with Fun", href: "/guides/ecosystem/prisma-postgres" },
          { title: "Create a Discord bot", href: "/guides/ecosystem/discordjs" },
          { title: "Add Sentry to a Fun app", href: "/guides/ecosystem/sentry" },
          { title: "Use Drizzle ORM with Fun", href: "/guides/ecosystem/drizzle" },
          { title: "Build a React app with Fun", href: "/guides/ecosystem/react" },
          { title: "Run Fun as a daemon with PM2", href: "/guides/ecosystem/pm2" },
          { title: "Build an app with Nuxt and Fun", href: "/guides/ecosystem/nuxt" },
          { title: "Build an app with Qwik and Fun", href: "/guides/ecosystem/qwik" },
          { title: "Build an app with Astro and Fun", href: "/guides/ecosystem/astro" },
          { title: "Build an app with Remix and Fun", href: "/guides/ecosystem/remix" },
          { title: "Use TanStack Start with Fun", href: "/guides/ecosystem/tanstack-start" },
          { title: "Run Fun as a daemon with systemd", href: "/guides/ecosystem/systemd" },
          { title: "Build an app with Next.js and Fun", href: "/guides/ecosystem/nextjs" },
          { title: "Build an app with SvelteKit and Fun", href: "/guides/ecosystem/sveltekit" },
          { title: "Build a frontend using Vite and Fun", href: "/guides/ecosystem/vite" },
          { title: "Build an app with SolidStart and Fun", href: "/guides/ecosystem/solidstart" },
          {
            title: "Use Neon Postgres through Drizzle ORM",
            href: "/guides/ecosystem/neon-drizzle",
          },
          { title: "Build an HTTP server using Hono and Fun", href: "/guides/ecosystem/hono" },
          {
            title: "Use Neon\'s Serverless Postgres with Fun",
            href: "/guides/ecosystem/neon-serverless-postgres",
          },
          { title: "Build an HTTP server using Elysia and Fun", href: "/guides/ecosystem/elysia" },
          { title: "Containerize a Fun application with Docker", href: "/guides/ecosystem/docker" },
          {
            title: "Build an HTTP server using Express and Fun",
          ...
          { title: "Build an HTTP server using StricJS and Fun", href: "/guides/ecosystem/stric" },
          {
            title: "Read and write data to MongoDB using Mongoose and Fun",
      ...
      },
      {
        ...
        items: [
          ...
          { title: "fetch with unix domain sockets in Fun", href: "/guides/http/fetch-unix" },
          {
          ...
          },
          {
            ...
            href: "/guides/http/stream-node-streams-in-fun",
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            title: "Using fun install with Artifactory",
          ...
          { title: "Generate a yarn-compatible lockfile", href: "/guides/install/yarnlock" },
          {
            ...
            href: "/guides/install/from-npm-install-to-fun-install",
          },
          ...
          { title: "Install a package under a different name", href: "/guides/install/npm-alias" },
          {
            ...
            href: "/guides/install/git-diff-fun-lockfile",
          },
          {
          ...
          {
            title: "Using fun install with an Azure Artifacts npm registry",
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Set a time zone in Fun", href: "/guides/runtime/timezone" },
          ...
          { title: "Debugging Fun with the web debugger", href: "/guides/runtime/web-debugger" },
          { title: "Install and run Fun in GitHub Actions", href: "/guides/runtime/cicd" },
          { title: "Install TypeScript declarations for Fun", href: "/guides/runtime/typescript" },
          {
            title: "Debugging Fun with the VS Code extension",
      ...
      },
      {
        ...
        icon: "test-tube",
        items: [
          { title: "Mock functions in fun test", href: "/guides/test/mock-functions" },
          { title: "Spy on methods in fun test", href: "/guides/test/spy-on" },
          { title: "Using Testing Library with Fun", href: "/guides/test/testing-library" },
          { title: "Update snapshots in fun test", href: "/guides/test/update-snapshots" },
          { title: "Run tests in watch mode with Fun", href: "/guides/test/watch-mode" },
          { title: "Use snapshot testing in fun test", href: "/guides/test/snapshot" },
          { title: "Bail early with the Fun test runner", href: "/guides/test/bail" },
          { title: "Skip tests with the Fun test runner", href: "/guides/test/skip-tests" },
          {
            title: "Migrate from Jest to Fun's test runner",
            href: "/guides/test/migrate-from-jest",
          },
          { title: "Run your tests with the Fun test runner", href: "/guides/test/run-tests" },
          { title: "Set the system time in Fun's test runner", href: "/guides/test/mock-clock" },
          {
            title: "Write browser DOM tests with Fun and happy-dom",
          ...
          {
            title: 'Mark a test as a "todo" with the Fun test runner',
            href: "/guides/test/todo-tests",
          },
          {
            title: "Re-run tests multiple times with the Fun test runner",
            href: "/guides/test/rerun-each",
          },
          {
            title: "Set a code coverage threshold with the Fun test runner",
          ...
          {
            title: "Generate code coverage reports with the Fun test runner",
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Get the current Fun version", href: "/guides/util/version" },
          ...
          { title: "Detect when code is executed with Fun", href: "/guides/util/detect-fun" },
