...
<Callout icon="discord">For general questions, please join our [Discord](https://fun.dev/discord).</Callout>

## Reporting Issues

<Steps>
	<Step title="Upgrade Fun">
		Try upgrading Fun to the latest version with `fun upgrade`. This might fix your problem without having to open an issue.
    ...
    <Step title="Review Existing Issues">
    	...
    	- 🔍 [**Search existing issues**](https://github.com/underdoc-org/fun/issues)
    	- 💬 [**Check discussions**](https://github.com/underdoc-org/fun/discussions)
    ...
    <Step title="Report the Issue">
    	...
    	- 🐞 [**Report a Bug**](https://github.com/underdoc-org/fun/issues/new?template=2-bug-report.yml)
    	- ⚡ [**Suggest an Improvement**](https://github.com/underdoc-org/fun/issues/new?template=4-feature-request.yml)

    	Please provide as much detail as possible, including:
    	- A clear and concise title
    	- A code example or steps to reproduce the issue
    	- The version of Fun you are using (run `fun --version`)
...
The Fun team will review the issue and get back to you as soon as possible!

---

## Use `fun feedback`

Alternatively, you can use `fun feedback` to share feedback, bug reports, and feature requests directly with the Fun team.
