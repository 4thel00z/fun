...
declare module "fun:test" {
   ...
   *
   * ```js
   * import { setSystemTime } from 'fun:test';
   *
   ...
   * Provides Vitest-style mocking API for easier migration from Vitest to Fun
   */
  export const vi: {
    /**
  ...
  export interface MatchersBuiltin<T = unknown> {
     ...
     * expect("bar").not.toSatisfy((val) => val === "fun");
