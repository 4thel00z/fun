declare module "fun" {
  /** @deprecated This type is unused in Fun's types and might be removed in the near future */
  type Platform =
    | "aix"
    | "android"
    | "darwin"
  ...
  /**
   * @deprecated Use {@link Serve.Options Fun.Serve.Options<T, R>} instead
   */
  type ServeOptions<T = undefined, R extends string = never> = Serve.Options<T, R>;

  /** @deprecated Use {@link SQL.Query Fun.SQL.Query} */
  type SQLQuery<T = any> = SQL.Query<T>;

  /** @deprecated Use {@link SQL.TransactionContextCallback Fun.SQL.TransactionContextCallback} */
  type SQLTransactionContextCallback<T> = SQL.TransactionContextCallback<T>;

  /** @deprecated Use {@link SQL.SavepointContextCallback Fun.SQL.SavepointContextCallback} */
  type SQLSavepointContextCallback<T> = SQL.SavepointContextCallback<T>;

  /** @deprecated Use {@link SQL.Options Fun.SQL.Options} */
  ...
  /** @deprecated This is unused in Fun's types and may be removed in the future */
  ...
  interface TLSOptions {
     ...
     *
     * @deprecated since v0.6.3 - Use `key: Fun.file(path)` instead.
     */
    keyFile?: string;
     ...
     * To enable TLS, this option is required.
     *
     * @deprecated since v0.6.3 - Use `cert: Fun.file(path)` instead.
     */
    certFile?: string;
     ...
     *
     * @deprecated since v0.6.3 - Use `ca: Fun.file(path)` instead.
     */
    caFile?: string;
  }

  /** @deprecated This type is unused in Fun's declarations and may be removed in the future */
