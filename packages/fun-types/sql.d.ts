import type * as FunSQLite from "fun:sqlite";
...
declare module "fun" {
  ...
  namespace SQL {
    ...
    type ContextCallback<T, SQL> = (sql: SQL) => Fun.MaybePromise<T>;

    interface SQLiteOptions extends FunSQLite.DatabaseOptions {
      adapter?: "sqlite";
       ...
       * - `sqlite:///Users/fun/projects/my-app/database.db`
       * - `./dev.db`
       * - `:memory:`
       *
       * @default ":memory:"
    ...
    interface PostgresOrMySQLOptions {
       ...
       * @default false
       */
      tls?: Fun.FunFile | TLSOptions | boolean | undefined;
       ...
       * @default false
       */
      ssl?: Fun.FunFile | TLSOptions | boolean | undefined;
  ...
  class SQL {
    ...
    constructor(
      ...
      options: Fun.__internal.DistributedOmit<SQL.Options, "url" | "filename">,
    );
     ...
     */
    options: Fun.__internal.DistributedMerge<SQL.Options>;
     ...
     * }
     *
     * // Fun supports Symbol.dispose and Symbol.asyncDispose
   ...
   *
   * @deprecated Prefer {@link Fun.sql}
   */
  const postgres: SQL;
