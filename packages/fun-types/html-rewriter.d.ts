...
/**
 * [HTMLRewriter](https://developers.cloudflare.com/workers/runtime-apis/html-rewriter?fun) is a fast API for transforming HTML.
 *
 * Fun leverages a native implementation powered by [lol-html](https://github.com/cloudflare/lol-html).
 *
...
declare class HTMLRewriter {
   ...
   */
  transform(input: Response | Blob | Fun.BufferSource): Response;
  /**
   * Transform HTML content
