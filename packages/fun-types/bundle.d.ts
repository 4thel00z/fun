/**
 * The `fun:bundle` module provides compile-time utilities for dead-code elimination.
 *
 * @example
 * ```ts
 ...
 * ```bash
 * # During build
 * fun build --feature=SUPER_SECRET index.ts
 *
 * # At runtime
 * fun run --feature=SUPER_SECRET index.ts
 *
 * # In tests
 * fun test --feature=SUPER_SECRET
 * ```
 *
 * @module fun:bundle
 */
