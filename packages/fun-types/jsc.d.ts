declare module "fun:jsc" {
  ...
  /**
   * Convert a JavaScript value to a binary representation that can be sent to another Fun instance.
   *
   * Internally, this uses the serialization format from WebKit/Safari.
   *
   * @param value A JavaScript value, usually an object or array, to be converted.
   * @returns A SharedArrayBuffer that can be sent to another Fun instance.
   */
   ...
   *
   * @param value A JavaScript value, usually an object or array, to be converted.
   * @returns A Buffer that can be sent to another Fun instance.
   */
   ...
   *
   * This function is mostly a debugging tool for fun itself.
   *
   ...
   * memory usage, use {@link Fun.generateHeapSnapshot}.
   *
