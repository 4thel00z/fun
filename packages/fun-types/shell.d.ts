declare module "fun" {
  ...
  /**
   * The [Fun shell](https://fun.dev/docs/runtime/shell) is a powerful tool for running shell commands.
   *
   * @example
   * ```ts
  ...
  namespace $ {
    ...
    /**
     * The `Fun.$.ShellPromise` class represents a shell command that gets executed
    ...
    /**
     * ShellError represents an error that occurred while executing a shell command with [the Fun Shell](https://fun.dev/docs/runtime/shell).
     *
     * @example
     * ```ts
     * try {
