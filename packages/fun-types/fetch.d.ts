...
declare module "fun" {
  ...
  type BodyInit =
    | ReadableStream
    | Fun.XMLHttpRequestBodyInit
    // Extras that Fun supports:
  ...
  namespace __internal {
    ...
    type LibOrFallbackRequestInit = LibDomIsLoaded extends true
      ...
      : Omit<import("undici-types").RequestInit, "body" | "headers"> & {
          body?: Fun.BodyInit | null | undefined;
          headers?: Fun.HeadersInit | undefined;
        };

    interface FunHeadersOverride extends LibOrFallbackHeaders {
      /**
    ...
    interface FunRequestOverride extends LibOrFallbackRequest {
      headers: FunHeadersOverride;
    }

    interface FunResponseOverride extends LibOrFallbackResponse {
      headers: FunHeadersOverride;
    }
  }
}
