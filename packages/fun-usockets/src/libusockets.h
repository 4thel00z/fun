...
struct us_socket_vtable_t {
    ...
    void (*on_handshake)(us_socket_r, int success, struct us_fun_verify_error_t, void *custom_data);
};
 ...
 * for the lifetime of the socket). Used for STARTTLS / Fun.connect upgrade.
 * sni may be NULL. */
...
struct us_fun_socket_context_options_t {
...
enum create_fun_socket_error_t {
    CREATE_FUN_SOCKET_ERROR_NONE = 0,
    CREATE_FUN_SOCKET_ERROR_LOAD_CA_FILE,
    CREATE_FUN_SOCKET_ERROR_INVALID_CA_FILE,
    CREATE_FUN_SOCKET_ERROR_INVALID_CA,
    CREATE_FUN_SOCKET_ERROR_INVALID_CIPHERS,
};
