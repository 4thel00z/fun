...
struct Http3Context {
    ...
    static Http3Context *create(Loop *loop, us_fun_socket_context_options_t options, unsigned idleTimeoutSecs = 0) {
    ...
    bool addServerName(const char *hostname, us_fun_socket_context_options_t options) {
