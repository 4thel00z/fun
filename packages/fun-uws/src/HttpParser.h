...
extern "C" int16_t Fun__HTTPMethod__from(const char *str, size_t len);
...
namespace uWS
{
    ...
    private:
        ...
        const size_t MAX_FALLBACK_SIZE = FUN_DEFAULT_MAX_HTTP_HEADER_SIZE;
        ...
        static bool isValidMethod(std::string_view str, bool useStrictMethodValidation) {
            ...
            if (useStrictMethodValidation) {
                return Fun__HTTPMethod__from(str.data(), str.length()) != -1;
            }
