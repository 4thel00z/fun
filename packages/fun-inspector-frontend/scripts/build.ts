...
try {
  const basePath = join(import.meta.dir, "../../../src/fun.js/WebKit/Source/WebInspectorUI/UserInterface");
  const htmlPath = join(basePath, "Main.html");
  const backendCommands = join(
    import.meta.dir,
    "../../../src/fun.js/WebKit/WebKitBuild/Release/JavaScriptCore/DerivedSources/inspector/InspectorBackendCommands.js",
  );
  ...
  const html = new HTMLRewriter()
    ...
    //     },
    //   })
    .transform(new Response(Fun.file(htmlPath)));
  ...
  await Fun.write(join(import.meta.dir, "out/manifest.js"), javascript);
  mkdirSync("out/WebKitAdditions/WebInspectorUI/", { recursive: true });
  await Fun.write(join(import.meta.dir, "out/WebKitAdditions/WebInspectorUI/WebInspectorUIAdditions.js"), "");
  await Fun.write(join(import.meta.dir, "out/WebKitAdditions/WebInspectorUI/WebInspectorUIAdditions.css"), "");
  // await Fun.write(join(import.meta.dir, "manifest.css"), css);
  const jsBundle = await Fun.build({
  ...
  await Fun.write(join(import.meta.dir, "out", jsFilename), jsBundle.outputs[0]);
  // await Fun.write(join(import.meta.dir, "out", cssFilename), cssBundle.outputFiles[0].text);
  await Fun.write(join(import.meta.dir, "out", "index.html"), htmlText);
  await Fun.write(join(import.meta.dir, "out", "index.html"), htmlText);
  await Fun.write(join(import.meta.dir, "out", "Protocol", "InspectorBackendCommands.js"), Fun.file(backendCommands));
