...
import { SocketFramer } from "../../../fun-debug-adapter-protocol/src/debugger/node-socket-framer.js";
 ...
 *
 * 1. Extension sets environment variable `FUN_INSPECT_NOTIFY` inside of all vscode terminals.
 *    This is a path to a unix socket that the extension will listen on.
 * 2. Fun reads it and connects to the socket, setting up a reverse connection for sending DAP
 *    messages.
 */
