...
extern "C" {
    pub static FUN_LOADER_MAX: FunLoader;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct FunLogOptions {
...
pub struct OnBeforeParseResult {
    ...
    pub log: ::std::option::Option<
        unsafe extern "C" fn(args: *const OnBeforeParseArguments, options: *mut FunLogOptions),
    >,
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum FunLogLevel {
...
extern "C" {
    pub static FUN_LOG_MAX: FunLogLevel;
}
