...
const { FunTestController } = await import("../fun-test-controller");
...
const controller = new FunTestController(mockTestController, mockWorkspaceFolder, true);
const internal = controller._internal;

describe("FunTestController", () => {
  beforeEach(() => {
...
describe("FunTestController - Test Discovery and Management", () => {
  ...
  describe("getFunExecutionConfig", () => {
    test("should return fun execution configuration", () => {
      const config = internal.getFunExecutionConfig();
      expect(config).toHaveProperty("testArgs");
      expect(config).toHaveProperty("funCommand");
      expect(Array.isArray(config.testArgs)).toBe(true);
      expect(typeof config.funCommand).toBe("string");
    });
    ...
    test("should include common fun test options", () => {
      const config = internal.getFunExecutionConfig();
      const args = config.testArgs.join(" ");
      expect(config.funCommand).toBe("fun");
    });
  });
});

describe("FunTestController - Test Item Management", () => {
...
describe("FunTestController - Error Handling", () => {
...
describe("FunTestController - Integration and Coverage", () => {
  describe("_internal getter", () => {
    test("should expose all expected internal methods", () => {
      ...
      expect(internal).toHaveProperty("getFunExecutionConfig");
    ...
    test("should expose functions that are callable", () => {
      ...
      expect(typeof internal.getFunExecutionConfig).toBe("function");
